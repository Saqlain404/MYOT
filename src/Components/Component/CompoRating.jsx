<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/component-rating.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:41:54 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
  ...
  <link
    rel="stylesheet"
    href="../../dist/libs/jquery-raty-js/lib/jquery.raty.css"
  />
  {/* --------------------------------------------------- */}
  {/* Core Css */}
  {/* --------------------------------------------------- */}
      ...
      <div className="container-fluid">
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Rating</h4>
        ...
        <div className="row">
          <div className="col-md-6 col-lg-4">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Default</h4>
              </div>
              <div className="card-body">
                <p>This is the most basic example of ratings.</p>
                <div id="default-star-rating" />
              </div>
            </div>
          </div>
          <div className="col-md-6 col-lg-4">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Score</h4>
              </div>
              <div className="card-body">
                <p>Used when we want starts with a saved rating.</p>
                <div id="score-rating" />
                <img
                  src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/rating/"
                  alt=""
                />
              </div>
            </div>
          ...
          <div className="col-md-6 col-lg-4">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Number Of Stars</h4>
              </div>
              <div className="card-body">
          ...
          <div className="col-md-6 col-lg-4">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Number Max</h4>
              </div>
              <div className="card-body">
                <p>Change the maximum of stars that can be created.</p>
                <div id="max-number-stars" />
              </div>
            </div>
          </div>
          <div className="col-md-6 col-lg-4">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Read Only</h4>
              </div>
              <div className="card-body">
                <p>
          ...
          <div className="col-md-6 col-lg-4">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">No Rated Message</h4>
              </div>
              <div className="card-body">
                <p>
          ...
          <div className="col-md-6 col-lg-4">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Cancel</h4>
              </div>
              <div className="card-body">
                <p>
          ...
          <div className="col-md-6 col-lg-4">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Space</h4>
              </div>
              <div className="card-body">
                <p>
          ...
          <div className="col-md-6 col-lg-4">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Single</h4>
              </div>
              <div className="card-body">
                <p>
                  You can turn on just the mouseovered star instead all from the
                  first until that one.
                </p>
                <div id="single-star" />
              </div>
            </div>
          ...
          <div className="col-md-6 col-sm-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Half</h4>
              </div>
              <div className="card-body">
                <p>
          ...
          <div className="col-md-6 col-sm-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Star Half</h4>
              </div>
              <div className="card-body">
          ...
          <div className="col-md-6 col-sm-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Custom Icon</h4>
              </div>
              <div className="card-body">
                <p>Change the maximum of stars that can be created.</p>
                <div id="custom-icon-star" />
              </div>
            </div>
          </div>
          <div className="col-md-6 col-sm-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Icon Range</h4>
              </div>
              <div className="card-body">
                <p>Change the maximum of stars that can be created.</p>
                <div id="icon-range" />
          ...
          <div className="col-md-6 col-sm-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Round Figure Enabled</h4>
              </div>
              <div className="card-body">
          ...
          <div className="col-md-6 col-sm-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Round Figure Disabled</h4>
              </div>
              <div className="card-body">
                <ul className="list-style-none mb-3">
