<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/component-nestable.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:41:52 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
      ...
      <div className="container-fluid">
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Nestable</h4>
        ...
        <div className="row">
          <div className="col-lg-4 col-md-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Nestable1</h4>
              </div>
          ...
          <div className="col-lg-4 col-md-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Nestable2</h4>
              </div>
              <div className="card-body">
                <div className="myadmin-dd-empty dd" id="nestable2">
                  <ol className="dd-list">
                    ...
                    <li className="dd-item dd3-item" data-id={14}>
                      <div className="dd-handle dd3-handle" />
                      <div className="dd3-content">Item 19</div>
                    </li>
          ...
          <div className="col-lg-4 col-md-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Nestable3</h4>
              </div>
              <div className="card-body">
                <div className="dd myadmin-dd" id="nestable-menu">
                  <ol className="dd-list">
                    <li className="dd-item" data-id={13}>
                      <div className="dd-handle">Item 13</div>
                    </li>
                    <li className="dd-item" data-id={13}>
                      <div className="dd-handle">Item 13</div>
                    </li>
                    <li className="dd-item" data-id={14}>
                      <div className="dd-handle">Item 14</div>
                    </li>
                    <li className="dd-item" data-id={15}>
                      <div className="dd-handle">Item 15</div>
                      <ol className="dd-list">
                        <li className="dd-item" data-id={16}>
                          <div className="dd-handle">Item 16</div>
                        </li>
                        <li className="dd-item" data-id={17}>
                          <div className="dd-handle">Item 17</div>
                        </li>
                        <li className="dd-item" data-id={18}>
                          <div className="dd-handle">Item 18</div>
                        </li>
                        <li className="dd-item" data-id={16}>
                          <div className="dd-handle">Item 19</div>
                        </li>
                        <li className="dd-item" data-id={17}>
                          <div className="dd-handle">Item 20</div>
                        </li>
                        <li className="dd-item" data-id={18}>
                          <div className="dd-handle">Item 21</div>
                        </li>
                      </ol>
                    </li>
                  </ol>
