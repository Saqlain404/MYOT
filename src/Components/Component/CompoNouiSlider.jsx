<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/component-noui-slider.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:41:52 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
  ...
  <link
    rel="stylesheet"
    href="../../dist/libs/nouislider-orxe/distribute/nouislider.min.css"
  />
  {/* --------------------------------------------------- */}
  {/* Core Css */}
  {/* --------------------------------------------------- */}
  ...
  >
      ...
      <div className="container-fluid">
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Noui-Slider</h4>
        ...
        <div className="row">
          <div className="col-lg-6 col-sm-6 col-12">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Handles</h4>
                <div className="mb-3 mt-2">
                  <div id="slider-handles" className="mt-3 mb-3" />
                  <p>
                    The number of handles can be set using the
                    <code>start</code> option.
                  </p>
                </div>
                <h4 className="card-title">Stepping in non-linear sliders</h4>
                <div className="mb-3 mt-2">
                  <div id="slider-non-linear-step" className="mt-3 mb-3" />
                  <p>
                ...
                <div className="mb-3 mt-2">
                  <div id="slider-step" className="mt-3 mb-3" />
                  <p>
          ...
          <div className="col-lg-6 col-sm-6 col-12">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Non-linear sliders</h4>
                <div className="mb-3 mt-2">
                  <div id="slider-non-linear" className="mt-3 mb-3" />
                  <p>
                ...
                <div className="mb-3 mt-2">
                  <div id="slider-range" className="mt-3 mb-3" />
                  <p>
                    All values on the slider are part of a range. The range has
                    a minimum and maximum value.
                  </p>
                </div>
                <h4 className="card-title">Snapping between steps</h4>
                <div className="mb-3 mt-2">
                  <div id="slider-snap" className="mt-3 mb-3" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          ...
          <div className="col-lg-6 col-sm-6 col-12">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Tap</h4>
                <div className="mb-3 mt-2">
                  <div id="tap" className="mt-3 mb-3" />
                  <p>
                    A handle snaps to a clicked location. A smooth transition is
                    used. This option is <code>default</code>.
                  </p>
                </div>
                <h4 className="card-title">Drag</h4>
                <div className="mb-3 mt-2">
                  <div id="drag" className="mt-3 mb-3" />
                  <p>
                ...
                <h4 className="card-title">Fixed dragging</h4>
                <div className="mb-3 mt-2">
                  <div id="drag-fixed" className="mt-3 mb-3" />
                  <p>
          ...
          <div className="col-lg-6 col-sm-6 col-12">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Snap</h4>
                <div className="mb-3 mt-2">
                  <div id="snap" className="mt-3 mb-3" />
                  <p>
                    A handle snaps to a clicked location. It can immediately be
                    moved, without a <code>mouseup</code> +
                    <code>mousedown</code>.
                  </p>
                </div>
                <h4 className="card-title">Hover</h4>
                <div className="mb-3 mt-2">
                  <div id="hover" className="mt-3 mb-3" />
                  <p>
                ...
                <h4 className="card-title">Combined options</h4>
                <div className="mb-3 mt-2">
                  <div id="combined" className="mt-3 mb-3" />
                  <p>
                    Most <code>'behavior'</code> flags can be combined.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="row">
          <div className="col-lg-6 col-sm-6 col-12">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Left to right</h4>
                <p>
                  The <code>range</code> mode uses the slider range to determine
                  where the pips should be. A pip is generated for every
                  percentage specified.
                </p>
                <div className="mb-3 mt-2">
                  <div id="pips-range" className="mt-3 mb-5" />
                </div>
              </div>
            </div>
          </div>
          <div className="col-lg-6 col-sm-6 col-12">
            <div className="card">
              <div className="card-body">
                ...
                <div className="mb-3 mt-2">
                  <div id="pips-range-rtl" className="mt-3 mb-5" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-12">
            <div className="card">
              <div className="card-body">
                ...
                <p>
                  Like <code>range</code>, the <code>steps</code> mode uses the
                  slider range. In <code>steps</code> mode, a pip is generated
                  for every step. The <code>filter</code> option can be used to
                  filter the generated pips. The
                  <code>filter</code> function must return <code>0</code> (no
                  value), <code>1</code> (large value) or
                  <code>2</code> (small value).
                </p>
                <div className="mb-3 mt-2">
                  <div id="pips-steps-filter" className="mb-5" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="card">
              <div className="card-body">
                <fieldset>
                  ...
                  <div className="mb-3 mt-2">
                    <div id="default-color-slider" className="" />
                  </div>
                </fieldset>
                <fieldset>
                  ...
                  <div className="mb-3 mt-2">
                    <div
                      ...
                      className="circle-filled slider-success"
                    />
                  </div>
                </fieldset>
                <fieldset>
            ...
            <div className="card">
              <div className="card-body">
                <fieldset>
                  ...
                  <div className="mb-3 mt-2">
                    <div id="warning-color-slider" className="slider-warning" />
                  </div>
                </fieldset>
                <fieldset>
                  ...
                  <div className="mb-3 mt-2">
                    <div
                      ...
                      className="circle-filled slider-danger"
                    />
                  </div>
                </fieldset>
                <fieldset>
                  ...
                  <div className="mb-3 mt-2">
                    <div
                      ...
                      className="square slider-purple"
                    />
                  </div>
                </fieldset>
              </div>
        ...
        <div className="row">
          ...
          <div className="col-lg-4 col-12">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Default Handle</h4>
                <fieldset className="mt-3">
                  <label>Extra Large Size</label>
                  <div className="mb-3 mt-2">
                    <div className="slider-xl" id="extra-large-slider" />
                  </div>
                </fieldset>
                <fieldset>
                  ...
                  <div className="mb-3 mt-2">
                    <div
                      className="slider-lg slider-success"
                      id="large-slider"
                    />
                  </div>
                </fieldset>
                <fieldset>
                  <label>Default</label>
                  <div className="mb-3 mt-2">
                    <div className="slider-info" id="default-slider" />
                  </div>
                </fieldset>
                <fieldset>
                  ...
                  <div className="mb-3 mt-2">
                    <div
                      className="slider-sm slider-warning"
                      id="small-slider"
                    />
                  </div>
                </fieldset>
                <fieldset>
                  ...
                  <div className="mb-3 mt-2">
                    <div
                      className="slider-xs slider-danger"
                      id="extra-small-slider"
                    />
                  </div>
                </fieldset>
              </div>
          ...
          <div className="col-lg-4 col-12">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Circle Filled Handle</h4>
                <fieldset className="mt-3">
                  <label>Extra Large Size</label>
                  <div className="mb-3 mt-2">
                    <div
                      className="circle-filled slider-xl"
                      id="circle-extra-large-slider"
                    />
                  </div>
                </fieldset>
                <fieldset>
                  ...
                  <div className="mb-3 mt-2">
                    <div
                      className="circle-filled slider-lg slider-success"
                      id="circle-large-slider"
                    />
                  </div>
                </fieldset>
                <fieldset>
                  ...
                  <div className="mb-3 mt-2">
                    <div
                      className="circle-filled slider-info"
                      id="circle-default-slider"
                    />
                  </div>
                </fieldset>
                <fieldset>
                  ...
                  <div className="mb-3 mt-2">
                    <div
                      className="circle-filled slider-sm slider-warning"
                      id="circle-small-slider"
                    />
                  </div>
                </fieldset>
                <fieldset>
                  ...
                  <div className="mb-3 mt-2">
                    <div
                      className="circle-filled slider-xs slider-danger"
                      id="circle-extra-small-slider"
                    />
                  </div>
                </fieldset>
              </div>
          ...
          <div className="col-lg-4 col-12">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Square Handle</h4>
                <fieldset className="mt-3">
                  <label>Extra Large Size</label>
                  <div className="mb-3 mt-2">
                    <div
                      className="square slider-xl"
                      id="square-extra-large-slider"
                    />
                  </div>
                </fieldset>
                <fieldset>
                  ...
                  <div className="mb-3 mt-2">
                    <div
                      className="square slider-lg slider-success"
                      id="square-large-slider"
                    />
                  </div>
                </fieldset>
                <fieldset>
                ...
                <fieldset>
                  ...
                  <div className="mb-3 mt-2">
                    <div
                      className="square slider-sm slider-warning"
                      id="square-small-slider"
                    />
                  </div>
                </fieldset>
                <fieldset>
                  ...
                  <div className="mb-3 mt-2">
                    <div
                      className="square slider-xs slider-danger"
                      id="square-extra-small-slider"
                    />
                  </div>
                </fieldset>
              </div>
        ...
        <div className="row">
          <div className="col-lg-4 col-md-12">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Default Vertical Slider</h4>
                <fieldset className="mt-3">
                  <div className="form-group text-center">
                    <div id="slider-vertical-1" />
                    <div id="slider-vertical-2" className="ms-3 slider-info" />
                    <div
                      id="slider-vertical-3"
                      className="ms-3 slider-success"
                    />
                    <div
                      id="slider-vertical-4"
                      className="ms-3 slider-warning"
                    />
                    <div
                      id="slider-vertical-5"
                      className="ms-3 slider-danger"
                    />
                  </div>
                </fieldset>
              </div>
          ...
          <div className="col-lg-4 col-md-12">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Connect to lower</h4>
                <fieldset className="mt-3">
                  <div className="form-group text-center">
                    <div id="connect-lower-1" />
                    <div id="connect-lower-2" className="ms-3 slider-info" />
                    <div id="connect-lower-3" className="ms-3 slider-success" />
                    <div id="connect-lower-4" className="ms-3 slider-warning" />
                    <div id="connect-lower-5" className="ms-3 slider-danger" />
                  </div>
                </fieldset>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-md-12">
            <div className="card">
              <div className="card-body">
                ...
                <fieldset className="mt-3">
                  <div className="form-group text-center">
                    <div id="connect-upper-1" />
                    <div id="connect-upper-2" className="ms-3 slider-info" />
                    <div id="connect-upper-3" className="ms-3 slider-success" />
                    <div id="connect-upper-4" className="ms-3 slider-warning" />
                    <div id="connect-upper-5" className="ms-3 slider-danger" />
                  </div>
                </fieldset>
              </div>
            </div>
        ...
        <div className="row">
          <div className="col-lg-4 col-md-12">
            <div className="card">
              <div className="card-body">
                ...
                <fieldset className="mt-3">
                  <div className="form-group text-center">
                    <div id="slider-tooltips-1" className="me-4" />
                    <div
                      id="slider-tooltips-2"
                      className="ms-5 me-4 slider-info"
                    />
                    <div
                      id="slider-tooltips-3"
                      className="ms-5 slider-warning"
                    />
                  </div>
                </fieldset>
              </div>
          ...
          <div className="col-lg-4 col-md-12">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Direction Top To Bottom</h4>
                <fieldset className="mt-3">
                  <div className="form-group text-center">
                    <div id="slider-direction-top-bottom-1" className="me-4" />
                    <div
                      id="slider-direction-top-bottom-2"
                      className="ms-5 me-4 slider-warning"
                    />
                    <div
                      id="slider-direction-top-bottom-3"
                      className="ms-5 slider-danger"
                    />
                  </div>
                </fieldset>
              </div>
          ...
          <div className="col-lg-4 col-md-12">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Direction Bottom To Top</h4>
                <fieldset className="mt-3">
                  <div className="form-group text-center">
                    <div id="slider-direction-bottom-top-1" className="me-4" />
                    <div
                      id="slider-direction-bottom-top-2"
                      className="ms-5 me-4 slider-info"
                    />
                    <div
                      id="slider-direction-bottom-top-3"
                      className="ms-5 slider-success"
                    />
                  </div>
                </fieldset>
              </div>
          ...
          <div className="col-lg-4 col-md-12">
            <div className="card">
              <div className="card-body">
                ...
                <fieldset className="mt-3">
                  <div className="form-group text-center">
                    <div id="vertical-margin-1" />
                    <div id="vertical-margin-2" className="ms-3 slider-info" />
                    <div
                      id="vertical-margin-3"
                      className="ms-3 slider-success"
                    />
                    <div
                      id="vertical-margin-4"
                      className="ms-3 slider-warning"
                    />
                    <div
                      id="vertical-margin-5"
                      className="ms-3 slider-danger"
                    />
                  </div>
                </fieldset>
          ...
          <div className="col-lg-4 col-md-12">
            <div className="card">
              <div className="card-body">
                ...
                <fieldset className="mt-3">
                  <div className="form-group text-center">
                    <div id="vertical-limit-1" />
                    <div id="vertical-limit-2" className="ms-3 slider-info" />
                    <div
                      id="vertical-limit-3"
                      className="ms-3 slider-success"
                    />
                    <div
                      ...
                      className="ms-3 slider-warning"
                    />
                    <div id="vertical-limit-5" className="ms-3 slider-danger" />
                  </div>
                </fieldset>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-md-12">
            <div className="card">
              <div className="card-body">
                ...
                <fieldset className="mt-3">
                  <div className="form-group text-center">
                    <div id="vertical-steps-1" />
                    <div id="vertical-steps-2" className="ms-3 slider-info" />
                    <div
                      id="vertical-steps-3"
                      className="ms-3 slider-success"
                    />
                    <div
                      ...
                      className="ms-3 slider-warning"
                    />
                    <div id="vertical-steps-5" className="ms-3 slider-danger" />
                  </div>
                </fieldset>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-md-12">
            <div className="card">
              <div className="card-body">
                ...
                <fieldset className="mt-3">
                  <div className="form-group text-center">
                    <div id="vert-extra-large-slider" />
                    <div id="vert-large-slider" className="ms-3 slider-info" />
                    <div
                      id="vert-default-slider"
                      className="ms-3 slider-success"
                    />
                    <div
                      id="vert-small-slider"
                      className="ms-3 slider-warning"
                    />
                    <div
                      id="vert-extra-small-slider"
                      className="ms-3 slider-danger"
                    />
                  </div>
                </fieldset>
            ...
            <div className="card">
              <div className="card-body">
                ...
                <fieldset className="mt-3">
                  <div className="form-group text-center">
                    <div
                      id="vert-circle-extra-large-slider"
                      className="circle-filled"
                    />
                    <div
                      id="vert-circle-large-slider"
                      className="circle-filled ms-3 slider-info"
                    />
                    <div
                      id="vert-circle-default-slider"
                      className="circle-filled ms-3 slider-success"
                    />
                    <div
                      id="vert-circle-small-slider"
                      className="circle-filled ms-3 slider-warning"
                    />
                    <div
                      id="vert-circle-extra-small-slider"
                      className="circle-filled ms-3 slider-danger"
                    />
                  </div>
                </fieldset>
              </div>
            ...
            <div className="card">
              <div className="card-body">
                ...
                <fieldset className="mt-3">
                  <div className="form-group text-center">
                    <div
                      id="vert-square-extra-large-slider"
                      className="square"
                    />
                    <div
                      id="vert-square-large-slider"
                      className="square ms-3 slider-info"
                    />
                    <div
                      id="vert-square-default-slider"
                      className="square ms-3 slider-success"
                    />
                    <div
                      id="vert-square-small-slider"
                      className="square ms-3 slider-warning"
                    />
                    <div
                      id="vert-square-extra-small-slider"
                      className="square ms-3 slider-danger"
                    />
                  </div>
                </fieldset>
              </div>
    ...
    {/* ---------------------------------------------- */}
    {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/component-noui-slider.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:41:53 GMT */}
  </div>
</>
