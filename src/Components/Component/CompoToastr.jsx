<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/component-toastr.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:41:55 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
      ...
      <div className="container-fluid">
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Toastr</h4>
        ...
        <div className="row">
          <div className="col-lg-6">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Basic</h4>
              </div>
          ...
          <div className="col-lg-6">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Animation</h4>
              </div>
              <div className="card-body">
                <div className="button-group">
                  <button
          ...
          <div className="card-body">
            <div className="row">
              <div className="col-md-3 col-sm-12">
                <h4 className="card-title">Only Text</h4>
              ...
              <div className="col-md-3 col-sm-12">
                <h4 className="card-title">With Close Button</h4>
              ...
              <div className="col-md-3 col-sm-12">
                <h4 className="card-title">With Progress</h4>
