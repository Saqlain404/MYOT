<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:39:28 GMT */}
  {/*  Title */}
            ...
            <div className="card w-100">
              <div className="card-body">
                ...
                <div className="d-flex align-items-center">
                  ...
                  <div>
                    <span className="round-8 bg-secondary rounded-circle me-2 d-inline-block" />
          ...
          <div className="col-md-6 col-lg-4 d-flex align-items-stretch">
            <div className="card w-100">
              <div className="card-body">
                ...
                <div className="d-flex align-items-center justify-content-between">
                  <div className="d-flex align-items-center">
                    <div className="bg-light-primary rounded-2 me-8 p-8 d-flex align-items-center justify-content-center">
                  ...
                  <div className="d-flex align-items-center">
                    <div className="bg-light-secondary rounded-2 me-8 p-8 d-flex align-items-center justify-content-center">
                      <i className="ti ti-grid-dots text-secondary fs-6" />
                    </div>
                    <div>
                      <h6 className="fw-semibold text-dark fs-4 mb-0">
                        $23,450
          ...
          <div className="col-lg-4">
            <div className="row">
              <div className="col-sm-6 d-flex align-items-stretch">
                <div className="card w-100">
                  <div className="card-body">
                    <div className="p-2 bg-light-primary rounded-2 d-inline-block mb-3">
                      <img
                        src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/icon-cart.svg"
                        alt=""
                        className="img-fluid"
                        width={24}
                        height={24}
              ...
              <div className="col-sm-6 d-flex align-items-stretch">
                <div className="card w-100">
                  <div className="card-body">
                    <div className="p-2 bg-light-info rounded-2 d-inline-block mb-3">
                      <img
                        src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/icon-bar.svg"
                        alt=""
                        className="img-fluid"
                        width={24}
                        height={24}
                ...
                <div className="row alig n-items-start">
                  <div className="col-8">
                    ...
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <div className="d-flex align-items-center">
                        <span className="me-2 rounded-circle bg-light-success round-20 d-flex align-items-center justify-content-center">
                  ...
                  <div className="col-4">
                    <div className="d-flex justify-content-end">
                      <div className="p-2 bg-light-primary rounded-2 d-inline-block">
                        <img
                          src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/icon-master-card-2.svg"
                          alt=""
                          className="img-fluid"
                          width={24}
                          height={24}
              ...
              <div className="card-body">
                ...
                <div className="position-relative">
                  <div className="d-flex align-items-center justify-content-between mb-4">
                    <div className="d-flex">
                      <div className="p-6 bg-light-primary rounded-2 me-6 d-flex align-items-center justify-content-center">
                        <i className="ti ti-grid-dots text-primary fs-6" />
                      </div>
                      <div>
                  ...
                  <div className="d-flex align-items-center justify-content-between mb-4">
                    <div className="d-flex">
                      <div className="p-6 bg-light-success rounded-2 me-6 d-flex align-items-center justify-content-center">
                  ...
                  <div className="d-flex align-items-center justify-content-between">
                    <div className="d-flex">
                      <div className="p-6 bg-light-danger rounded-2 me-6 d-flex align-items-center justify-content-center">
              ...
              <div className="card-body">
                <div>
                  ...
                  <div className="d-flex align-items-center justify-content-between">
                    ...
                    <div className="d-flex align-items-center">
                      <div className="bg-light rounded-2 me-8 p-8 d-flex align-items-center justify-content-center">
                  ...
                  <div className="d-flex align-items-center justify-content-between mb-4">
                    <div className="d-flex">
                      <div className="p-8 bg-light-primary rounded-2 d-flex align-items-center justify-content-center me-6">
                        <img
                          src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/icon-paypal2.svg"
                          alt=""
                          className="img-fluid"
                          width={24}
                          height={24}
                  ...
                  <div className="d-flex align-items-center justify-content-between mb-4">
                    <div className="d-flex">
                      <div className="p-8 bg-light-success rounded-2 d-flex align-items-center justify-content-center me-6">
                        <img
                          src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/icon-wallet.svg"
                          alt=""
                          className="img-fluid"
                          width={24}
                          height={24}
                  ...
                  <div className="d-flex align-items-center justify-content-between mb-4">
                    <div className="d-flex">
                      <div className="p-8 bg-light-warning rounded-2 d-flex align-items-center justify-content-center me-6">
                        <img
                          src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/icon-credit-card.svg"
                          alt=""
                          className="img-fluid"
                          width={24}
                          height={24}
                  ...
                  <div className="d-flex align-items-center justify-content-between mb-7 pb-1">
                    <div className="d-flex">
                      <div className="p-8 bg-light-danger rounded-2 d-flex align-items-center justify-content-center me-6">
                        <img
                          src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/icon-pie2.svg"
                          alt=""
                          className="img-fluid"
                          width={24}
                          height={24}
  ...
  >
    ...
    <div className="offcanvas-body h-100" data-simplebar="">
            ...
            <div>
              ...
              <div className="d-flex align-items-center mt-1">
                ...
                <div className="input-group input-group-sm w-35">
                  <button
                    className="btn btn-light-success text-success rounded-1 minus"
                    type="button"
                    id="add1"
                  >
                    {" "}
                  ...
                  <input
                    type="text"
                    className="form-control bg-transparent border-0 rounded-1 text-center qty"
                    placeholder=""
                    aria-label="Example text with button addon"
                    aria-describedby="add1"
                    defaultValue={1}
                  />
                  <button
                    className="btn btn-light-success text-success rounded-1 add"
                    type="button"
                    id="addo2"
                  >
                    {" "}
      ...
      <div className="align-bottom">
        ...
        <a
          className="btn btn-primary text-white w-100 d-block"
          href="javascript:void(0);"
        >
          {" "}
          Place order{" "}
  ...
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:39:29 GMT */}
</>
