<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/index5.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:39:36 GMT */}
  {/*  Title */}
      ...
      <div className="container-fluid">
        <div className="row">
                    ...
                    <div className="d-flex flex-column align-items-start w-100">
                      ...
                      <div className="mt-lg-auto mt-4 mb-4">
                        <span className="text-dark">
                          Total Revenue{" "}
                          <span className="text-success">+9.78%</span>
                        </span>
            ...
            <div className="card w-100">
              <div className="card-body">
                ...
                <div className="mt-9 py-6 d-flex align-items-center">
                  <div className="flex-shrink-0 bg-light-primary rounded-circle round d-flex align-items-center justify-content-center">
                    <i className="ti ti-map-pin text-primary fs-6" />
                  </div>
                  <div className="ms-3">
                ...
                <div className="py-6 d-flex align-items-center">
                  <div className="flex-shrink-0 bg-light-danger rounded-circle round d-flex align-items-center justify-content-center">
                    <i className="ti ti-bookmark fs-6 text-danger" />
                  </div>
                  <div className="ms-3">
                ...
                <div className="py-6 d-flex align-items-center">
                  <div className="flex-shrink-0 bg-light-success rounded-circle round d-flex align-items-center justify-content-center">
                    <i className="ti ti-microphone fs-6 text-success" />
                  </div>
                  <div className="ms-3">
                ...
                <div className="py-6 d-flex align-items-center">
                  <div className="flex-shrink-0 bg-light-warning rounded-circle round d-flex align-items-center justify-content-center">
                    <i className="ti ti-cast text-warning fs-6" />
                  </div>
                  <div className="ms-3">
                ...
                <div className="pt-6 d-flex align-items-center">
                  <div className="flex-shrink-0 bg-light-info rounded-circle round d-flex align-items-center justify-content-center">
                    <i className="ti ti-mail text-info fs-6" />
                  </div>
                  <div className="ms-3">
          ...
          <div className="col-lg-7 d-flex align-items-stretch">
            <div className="card w-100 bg-light-primary overflow-hidden">
              <div className="card-body">
                <div className="d-flex align-items-center">
                  <div>
                    ...
                    <div className="d-flex gap-2">
                      <span>
                        <span className="round-8 bg-primary rounded-circle d-inline-block" />
                      </span>
                          ...
                          <tr>
                            ...
                            <td className="text-end ps-0">
                              <span className="badge bg-light-warning text-warning rounded-pill">
                                <span className="round-8 bg-warning rounded-circle d-inline-block me-1" />
                                progress{" "}
                              </span>
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td className="text-end ps-0">
                              <span className="badge bg-light-success text-success rounded-pill">
                                <span className="round-8 bg-success rounded-circle d-inline-block me-1" />
                                delivered{" "}
                              </span>
                            </td>
                          </tr>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td className="text-end ps-0">
                              <a
                                href="javascript:void(0)"
                                className="badge bg-light-success text-success rounded-pill"
                              >
                                <span className="round-8 bg-success rounded-circle d-inline-block me-1" />
                                delivered{" "}
                              </a>
            ...
            <div className="card w-100">
              <div className="card-body">
                ...
                <div className="mt-4 pb-3 border-bottom">
                  <div className="d-flex align-items-center">
                    <span className="bg-light-primary text-primary badge">
                      Inprogress
                    </span>
                  ...
                  <span className="fs-3 lh-sm">
                    Designing an NFT-themed website with a creative concept so
                    th...
                  </span>
                ...
                <div className="py-3 border-bottom">
                  <div className="d-flex align-items-center">
                    <span className="bg-light-danger text-danger badge">
                      Inpending
                    </span>
                    <span className="fs-3 ms-auto">8 Jan 2023</span>
                  </div>
                ...
                <div className="pt-3">
                  <div className="d-flex align-items-center">
                    <span className="bg-light-success text-success badge">
                      Completed
                    </span>
                    <span className="fs-3 ms-auto">8 Feb 2023</span>
                  </div>
            ...
            <div className="card w-100">
              ...
              <div className="p-3">
                <div className="hstack gap-3 justify-content-center">
                  <div>
                    <span>
                      <span className="round-8 bg-primary rounded-circle d-inline-block me-2" />
                    </span>
                    <span className="fs-3 text-dark">Completed 124</span>
                  </div>
                  <div>
                    <span>
                      <span className="round-8 bg-danger rounded-circle d-inline-block me-2" />
                    </span>
