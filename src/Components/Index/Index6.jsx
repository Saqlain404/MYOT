<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/index6.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:39:36 GMT */}
  {/*  Title */}
                  ...
                  <div className="col-4 ms-n4">
                    <div className="position-relative p-7 border-start h-100">
                      ...
                      <ul className="">
                        <li className="mb-3">
                          <a
                            className="fw-semibold text-dark bg-hover-primary    "
                            href="page-pricing.html"
                          >
                            Pricing Page
                          </a>
      ...
      <div className="container-fluid">
        <div className="row">
          <div className="col-xl-8">
            <div className="card">
              <div className="card-body">
                <h5 className="card-title fw-semibold">Follow Artists</h5>
                <p className="card-subtitle">
                  Tips for Following Local Artists
                </p>
                <div className="overflow-auto mt-4" data-simplebar="">
                  <div className="hstack gap-9">
                    <a href="#" className="text-center flex-shrink-0 ">
                      <div className="border border-2 border-primary rounded-circle hover-img">
                        <img
                          src="../../dist/images/music/s1.jpg"
                          className="rounded-circle img-fluid m-1"
                          alt="art"
                          width={55}
                        />
                      </div>
                      <span className="d-block fs-3 mt-1  text-dark">
                        Dualia
                      </span>
                    </a>
                    <a href="#" className="text-center flex-shrink-0 ">
                      <div className="border border-2 border-primary rounded-circle hover-img">
                        <img
                          src="../../dist/images/music/s2.jpg"
                          className="rounded-circle img-fluid m-1"
                          alt="art"
                          width={55}
                        />
                      </div>
                      <span className="d-block fs-3 mt-1  text-dark">John</span>
                    </a>
                    <a href="#" className="text-center flex-shrink-0 ">
                      <div className="border border-2 border-primary rounded-circle hover-img">
                        <img
                          src="../../dist/images/music/s3.jpg"
                          className="rounded-circle img-fluid m-1"
                          alt="art"
                          width={55}
                        />
                    ...
                    <a href="#" className="text-center flex-shrink-0 ">
                      <div className="border border-2 border-white rounded-circle hover-img">
                        <img
                          src="../../dist/images/music/s4.jpg"
                          className="rounded-circle img-fluid m-1"
                          alt="art"
                          width={55}
                        />
                      </div>
                      <span className="d-block fs-3 mt-1  text-dark">Sia</span>
                    </a>
                    <a href="#" className="text-center flex-shrink-0 ">
                      <div className="border border-2 border-white rounded-circle hover-img">
                        <img
            ...
            <div className="card">
              <div className="card-body">
                <h5 className="card-title fw-semibold">Recently Played</h5>
                <p className="card-subtitle">
                  What's on My Playlist This Week?
                </p>
                <div className="row mt-3">
                  <div className="col-md-4 col-sm-6">
                    <div className="card shadow-none border position-relative mb-md-0">
                      <div className="overflow-hidden rounded">
                        <a href="javascript:void(0)">
                          <img
                            src="../../dist/images/music/album5.jpg"
                            className="rounded hover-img card-img"
                            alt="art"
                          />
                        </a>
                      </div>
                      <div className="p-2 d-flex">
                        ...
                        <div className="ms-auto">
                          <a
                            href="javascript:void(0)"
                            className="z-1 btn bg-white text-primary round-sm rounded-circle mt-n4 shadow-sm p-0 d-flex align-items-center justify-content-center"
                          >
                            <i className="ti ti-player-play text-primary fs-4" />
                          </a>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="card shadow-none border position-relative mb-md-0">
                      <div className="overflow-hidden rounded">
                        <a href="javascript:void(0)">
                          <div className="hover-img">
                            <img
                              src="../../dist/images/music/album7.jpg"
                              className="rounded hover-img card-img"
                              alt="art"
                            />
                          </div>
                      ...
                      <div className="p-2 d-flex">
                        <div>
                          ...
                          <span className="fs-2 text-nowrap">Arijit Singh</span>
                        </div>
                        <div className="ms-auto">
                          <a
                            href="javascript:void(0)"
                  ...
                  <div className="col-md-4 col-sm-6">
                    <div className="card border shadow-none position-relative mb-0">
                      <div className="overflow-hidden rounded">
                        <a href="javascript:void(0)">
                          <div className="hover-img">
                            <img
                              src="../../dist/images/music/album8.jpg"
                              className="rounded hover-img card-img"
                              alt="art"
                            />
                          </div>
                      ...
                      <div className="p-2 d-flex">
                        <div>
                          <h6 className="mt-2 mb-0 fw-semibold text-truncate">
                            Badshah Party
                          </h6>
                          <span className="fs-2 text-nowrap">Badshah</span>
                        </div>
                        <div className="ms-auto">
                          <a
                            href="javascript:void(0)"
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                <div className="card">
                  <div className="card-body p-4">
                    <h5 className="card-title">Favourite Artists</h5>
                    <p className="card-subtitle">The Iconic Music of Prince</p>
                    <div className="row gx-3 mt-4">
                      <div className="col-3">
                        <img
                          src="../../dist/images/music/s1.jpg"
          ...
          <div className="col-xl-4">
            <div className="card">
              <div className="card-body">
                <h5 className="card-title fw-semibold">Recent Search</h5>
                <p className="card-subtitle">
                  What's Next in the World of Search?
                </p>
                <div className="hstack my-4 gap-3">
                  <a
                    role="alert"
                    className="alert mb-0 py-2 badge bg-light-primary text-primary s rounded-pill d-flex align-items-center justify-content-between gap-2 "
                  >
                    Shiela On7{" "}
                    <span data-bs-dismiss="alert">
                      <i className="ti ti-square-x fs-4" />
                    </span>
                  </a>
                  <a
                    role="alert"
                    className="alert mb-0 py-2 badge bg-light-danger text-danger s rounded-pill d-flex align-items-center justify-content-between gap-2 "
                  >
                    Denny Caknan{" "}
                    <span data-bs-dismiss="alert">
                      <i className="ti ti-square-x fs-4" />
                ...
                <div className="card bg-light-primary shadow-none mb-0">
                  <div className="card-body px-3 py-4">
                    <div className="text-center">
                      <div className="mplayer">
                        <div
                          id="jp_container_N"
                          className="jp-video-270p jp-state-no-volume"
                        >
                          <div className="jp-type-playlist">
                            ...
                            <div className="jp-gui">
                              <div className="jp-interface">
                                <img
                                  src="../../dist/images/music/album3.jpg"
                                  className="rounded poster"
                                  alt="album"
                                  width={100}
                                />
                                <h5 className="mt-3 mb-0 jp-title fw-semibold fs-5" />
                                <span className="opacity-75 fs-3 jp-artist" />
                                <div className="jp-controls">
                                  <div>
                                    <a
                                      className="jp-repeat btn border-0 round-sm opacity-75 rounded-circle"
                                      title="repeat"
                                    >
                                      <i className="ti ti-repeat fs-4" />
                                    </a>
                                    <a
                                      className="jp-repeat-off hide btn border-0 round-sm rounded-circle"
                                      title="repeat off"
                                    >
                                      <i className="ti ti-repeat fs-4 text-primary" />
                                    </a>
                                  </div>
                                  <div>
                                    <a className="jp-previous btn border-0 round-sm opacity-75 rounded-circle">
                                      <i className="ti ti-chevrons-left fs-4" />
                                    </a>
                                  </div>
                                  <div>
                                    <a className="jp-play btn border-0 bg-white text-primary round-sm rounded-circle">
                                      <i className="ti ti-player-play fs-4" />
                                    </a>
                                    <a className="jp-pause btn border-0 bg-white text-primary round-sm rounded-circle">
                                      <i className="ti ti-player-pause" />
                                    </a>
                                  </div>
                                  <div>
                                    <a className="jp-next btn border-0 round-sm opacity-75 rounded-circle">
                                      <i className="ti ti-chevrons-right fs-4" />
                                    </a>
                                  </div>
                                  <div>
                                    <a
                                      className="jp-shuffle btn border-0 round-sm opacity-75 rounded-circle"
                                      title="shuffle"
                                    >
                                      <i className="ti ti-arrows-shuffle-2 fs-4" />
                                    </a>
                                    <a
                                      className="jp-shuffle-off hide btn border-0 round-sm rounded-circle"
                                      title="shuffle off"
                                    >
                                      <i className="ti ti-arrows-shuffle-2 fs-4 text-primary" />
                                    </a>
                                  </div>
                                </div>
                                <div className="jp-progress hidden-xs">
                                  ...
                                  >
                                    <div
                                      className="jp-play-bar play-progress"
                                      style={{ width: "0%" }}
                                    />
                                    <div className="jp-current-time current-time" />
                                    <div className="jp-duration duration" />
                                  </div>
                                </div>
                                <div>
                                  <a className="jp-mute " title="mute">
                                    <i className="ti ti-volume-3 text-muted fs-4" />
                                  </a>
                                  <a className="jp-unmute" title="unmute">
                                    <i className="ti ti-volume fs-4 text-primary" />
                                  </a>
                                </div>
                                <div className="jp-volume jp-music-volume">
                          ...
                          <div className="jp-playlist dropup" id="playlist">
                            <ul className="dropdown-menu bg-inverse m-b-0">
                              <li className="list-group-item" />
                            </ul>
                          </div>
                          <div className="jp-no-solution hide">
                            <span>Update Required</span> To play the media you
                            will need to either update your browser to a recent
                    ...
                    <div className="d-flex align-items-center mt-3 p-3 bg-hover-light-black rounded border-bottom">
                      <div className="position-relative d-flex align-items-center">
                        ...
                        />
                        <img
                          src="../../dist/images/music/album1.jpg"
                          width={45}
                          className="rounded"
                          alt="album"
                        />
                        <div className="ms-3">
                          <h6 className="mb-0 fw-semibold">Viva Las</h6>
                          <span className="fs-2">Viva Las</span>
                        </div>
                      </div>
                      <div className="ms-auto">
                        <div className="dropdown">
                          ...
                          <ul className="dropdown-menu" aria-labelledby="m1">
                            <li>
                              <a className="dropdown-item" href="#">
                                <i className="ti ti-share text-muted me-1 fs-4" />
                                Share{" "}
                              </a>
                            </li>
                            <li>
                              <a className="dropdown-item" href="#">
                                <i className="ti ti-download text-muted me-1 fs-4" />
                                Download{" "}
                              </a>
                            </li>
                            <li>
                              <a className="dropdown-item" href="#">
                                <i className="ti ti-info-circle text-muted me-1 fs-4" />
                                Get Song Info{" "}
                              </a>
                            </li>
                          </ul>
                    ...
                    <div className="d-flex align-items-center bg-hover-light-black rounded p-3 border-bottom">
                      <div className="position-relative d-flex align-items-center">
                        <a
                          href="javascript:void(0)"
                          className="stretched-link "
                        />
                        <img
                          src="../../dist/images/music/album2.jpg"
                          width={45}
                          alt="album"
                          className="rounded"
                        />
                        <div className="ms-3">
                          <h6 className="mb-0 fw-semibold">As It Was</h6>
                          <span className="fs-2">As It Was</span>
                        </div>
                      </div>
                      <div className="ms-auto">
                        <div className="dropdown">
                          ...
                          <ul className="dropdown-menu" aria-labelledby="m2">
                            <li>
                              <a className="dropdown-item" href="#">
                                <i className="ti ti-share text-muted me-1 fs-4" />
                                Share{" "}
                    ...
                    <div className="d-flex align-items-center p-3 bg-hover-light-black rounded">
                      <div className="position-relative d-flex align-items-center">
                        <a
                          href="javascript:void(0)"
                          className="stretched-link "
                        />
                        <img
                          src="../../dist/images/music/album4.jpg"
                          width={45}
                          alt="album"
                          className="rounded"
                        />
                        <div className="ms-3">
                          <h6 className="mb-0 fw-semibold text-truncate w-75">
                            RedTape Anthem
                          </h6>
                          <span className="fs-2">RedTape Anthem</span>
                        </div>
                      </div>
                      <div className="ms-auto">
                        <div className="dropdown">
                          ...
                          <ul className="dropdown-menu" aria-labelledby="m3">
                            <li>
                              <a className="dropdown-item" href="#">
                                <i className="ti ti-share text-muted me-1 fs-4" />
                                Share{" "}
                    ...
                    <div className="d-flex align-items-center p-3 bg-hover-light-black rounded border-bottom">
                      <div className="position-relative d-flex align-items-center">
                        <a
                          href="javascript:void(0)"
                          className="stretched-link "
          ...
          <div className="col-md-6 col-xl-4">
            <div className="card">
              <div className="card-body p-4">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-auto">
                    <div className="dropdown">
                      ...
                      <ul className="dropdown-menu" aria-labelledby="t1">
                        <li>
                          <a className="dropdown-item" href="#">
                            <i className="ti ti-share text-muted me-1 fs-4" />
                            Share{" "}
                ...
                <div
                  className="mt-4 overflow-auto gap-4"
                  style={{ height: 450 }}
                  data-simplebar=""
                >
                  <a href="javascript:void(0)" className="mb-4 d-block">
                    <img
                      src="../../dist/images/music/top10-1.jpg"
                  ...
                  <a href="javascript:void(0)" className="mb-4 d-block">
                    <img
                      src="../../dist/images/music/top10-2.jpg"
                      className="img-fluid rounded"
                      alt="album"
                    />
                  </a>
                  <a href="javascript:void(0)" className="d-block">
                    <img
                      src="../../dist/images/music/top10-3.jpg"
                      className="img-fluid rounded"
                      alt="album"
                    />
                  </a>
          ...
          <div className="col-md-6 col-xl-4">
            <div className="card">
              <div className="card-body p-4">
                <div className="d-flex align-items-center">
                  <div>
                    <h5 className="card-title fw-semibold">Top Playlist</h5>
                    <p className="card-subtitle">Based on your choic</p>
                  </div>
                  <div className="ms-auto">
                    <div className="dropdown">
                      <a
                      ...
                      <ul className="dropdown-menu" aria-labelledby="t2">
                        <li>
                          <a className="dropdown-item" href="#">
                            <i className="ti ti-share text-muted me-1 fs-4" />
                            Share{" "}
                ...
                <div
                  className="overflow-auto card mt-4 mb-0 shadow-none border"
                  style={{ height: 450 }}
                  data-simplebar=""
                >
                  <div className="hstack p-3 bg-hover-light-black position-relative border-bottom">
                    <a href="javascript:void(0)" className="stretched-link " />
                    <a className="" href="javascript:void(0)">
                      <i className="ti ti-player-play fs-5" />
                    </a>
                    <img
                      src="../../dist/images/music/album1.jpg"
                      alt="top-1"
                    ...
                    />
                    <div className="ms-3">
                      <h6 className="mb-0">N95</h6>
                      <span className="fs-3">Kendrick Lamar</span>
                    </div>
                    <div className="ms-auto">
                      <a className="" href="javascript:void(0)">
                        <i className="ti ti-heart text-primary fs-5" />
                      </a>
                    </div>
                  </div>
                  <div className="hstack p-3 bg-hover-light-black position-relative border-bottom">
                    ...
                    />
                    <div className="ms-3">
                      <h6 className="mb-0">Women</h6>
                      <span className="fs-3">Doja Cat</span>
                    </div>
                    <div className="ms-auto">
                      <a className="" href="javascript:void(0)">
                        <i className="ti ti-heart text-primary fs-5" />
                  ...
                  <div className="hstack p-3 bg-hover-light-black position-relative border-bottom">
                    ...
                    />
                    <div className="ms-3">
                      <h6 className="mb-0">Wait For U</h6>
                      <span className="fs-3">Future, Tems</span>
                    </div>
                    <div className="ms-auto">
                      <a className="" href="javascript:void(0)">
                        <i className="ti ti-heart text-muted fs-5" />
                      </a>
                    </div>
                  </div>
                  <div className="hstack p-3 bg-hover-light-black position-relative border-bottom">
                    ...
                    />
                    <div className="ms-3">
                      <h6 className="mb-0">Blinding Lights</h6>
                      <span className="fs-3">The Weekend</span>
                    </div>
                    <div className="ms-auto">
                      <a className="" href="javascript:void(0)">
                        <i className="ti ti-heart text-muted fs-5" />
                  ...
                  <div className="hstack p-3 bg-hover-light-black position-relative border-bottom">
                    ...
                    />
                    <div className="ms-3">
                      <h6 className="mb-0">Cooped Up</h6>
                      <span className="fs-3">Roddy Ricch</span>
                    </div>
                    <div className="ms-auto">
                      <a className="" href="javascript:void(0)">
                        <i className="ti ti-heart text-primary fs-5" />
                  ...
                  <div className="hstack p-3 bg-hover-light-black position-relative border-bottom">
                    ...
                    <img
                      src="../../dist/images/music/album6.jpg"
                      alt="top-1"
                      width={40}
                      className="rounded ms-3"
                    />
                  ...
                  <div className="hstack p-3 bg-hover-light-black position-relative">
                    <a href="javascript:void(0)" className="stretched-link " />
                    <a className="" href="javascript:void(0)">
                      <i className="ti ti-player-play fs-5" />
                    </a>
                    ...
                    />
                    <div className="ms-3">
                      <h6 className="mb-0">Party Anthem</h6>
                      <span className="fs-3">Arijit Singh</span>
                    </div>
                    <div className="ms-auto">
                      <a className="" href="javascript:void(0)">
                        <i className="ti ti-heart text-primary fs-5" />
          ...
          <div className="col-md-6 col-xl-4">
            <div className="card">
              <div className="card-body p-4">
                ...
                <p className="card-subtitle">Based on your preferences</p>
                <div className="mt-4 card p-3 rounded shadow-none border">
                  <div className="d-flex align-items-center">
                    <div className="position-relative">
                      <img
                        src="../../dist/images/music/album1.jpg"
                      ...
                      <div className="card-img-overlay d-flex align-items-center justify-content-center">
                        <button className="btn btn-primary rounded-circle round p-0">
                          <i className="ti ti-player-play fs-5" />
                        </button>
                      </div>
                    </div>
                    <div className="ms-3">
                      <h6 className="mb-0 fs-5">Trending Songs</h6>
                      <span className="d-block fs-3 my-1">
                        Top trending hits, refres..
                      </span>
                ...
                <div className="mt-4 card mb-0 p-3 rounded shadow-none border">
                  <div className="d-flex align-items-center">
                    <div className="position-relative">
                      <img
                        src="../../dist/images/music/album4.jpg"
  ...
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/index6.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:40:02 GMT */}
</>
