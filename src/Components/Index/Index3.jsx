<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/index3.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:39:30 GMT */}
  {/*  Title */}
  ...
  <link
    rel="stylesheet"
    href="../../dist/libs/owl.carousel/dist/assets/owl.carousel.min.css"
  />
  {/* Core Css */}
  ...
  >
    ...
    <div className="body-wrapper">
      ...
      <div className="container-fluid">
        <div className="row">
          <div className="col-xl-8 d-flex align-items-strech">
            <div className="card w-100">
              <div className="card-body p-4">
                <h5 className="card-title fw-semibold">Top Collectibles</h5>
                <p className="card-subtitle mb-0">
                  The Beginner's Guide to Collectible Items
                </p>
                <div className="owl-carousel collectibles-carousel owl-theme mt-9">
                  <div className="item">
                    <div className="card overflow-hidden mb-4 mb-md-0 shadow-none border">
                      <div className="position-relative">
                        <img
                          src="../../dist/images/nft/1.jpg"
                          className="img-fluid w-100"
                          alt={1}
                        />
                        <div className="card-img-overlay">
                          <div className="text-end">
                            <span className="badge bg-light-dark rounded-pill fs-2">
                              04h 09m 12s
                            </span>
                          </div>
                        </div>
                      </div>
                      <div className="p-9 text-start">
                        <h6 className="fw-semibold fs-4">Geo Runners</h6>
                        <div className="d-flex align-items-center mt-3 justify-content-between">
                          <div className="fs-3">Volume</div>
                          <h6 className="mb-0">
                            <i className="cc ETH" title="ETH" />
                            <span className="text-dark fw-bold">10.1</span> ETH
                          </h6>
                        </div>
                        <a
                          href="javascript:void(0)"
                  ...
                  <div className="item">
                    <div className="card overflow-hidden mb-4 mb-md-0 shadow-none border">
                      ...
                      <div className="p-9 text-start">
                        <h6 className="fw-semibold fs-4">Cube Runner</h6>
                        <div className="d-flex align-items-center mt-3 justify-content-between">
                          <div className="fs-3">Volume</div>
                          <h6 className="mb-0">
                            <i className="cc ETH" title="ETH" />
                  ...
                  <div className="item">
                    <div className="card overflow-hidden mb-4 mb-md-0 shadow-none border">
                      ...
                      <div className="p-9 text-start">
                        <h6 className="ffw-semibold fs-4">Algo cube</h6>
                        <div className="d-flex align-items-center mt-3 justify-content-between">
                          <div className="fs-3">Volume</div>
                          <h6 className="mb-0">
                            <i className="cc ETH" title="ETH" />
          ...
          <div className="col-xl-4 d-flex align-items-strech">
            <div className="card w-100">
              <div className="card-body p-4">
                <h5 className="card-title fw-semibold">My Wallets</h5>
                <p className="card-subtitle mb-0">
                  Smart Wallets for the Digital Age
                </p>
                <div className="card overflow-hidden mt-9">
                  <img
                    src="../../dist/images/backgrounds/my-card.jpg"
                    alt="bg-card"
                    height={220}
                  />
                  <div className="card-img-overlay text-white">
                    <div className="d-flex align-items-start flex-column h-100">
                      <div>
                        <img
                          src="../../dist/images/nft/mastercard.png"
                          width={40}
                          alt="mastercard"
                        />
                        <span className="opacity-75 fs-2 d-block mt-3">
                          CARD NUMBER
                        </span>
                      ...
                      <div className="d-flex align-items-center justify-content-between mt-auto w-100">
                        <div>
                          <span className="opacity-75 fs-2 text-uppercase">
                            Card Holder Name
                          </span>
                          <h6 className="text-white mb-0">HR John</h6>
                        </div>
                        <div>
                          <span className="opacity-75 fs-2 text-uppercase">
                            Expires On
                          </span>
                          <h6 className="text-white mb-0">09/25</h6>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="card shadow-none mb-0">
                  <div className="card-body p-0">
                    <div className="d-flex align-items-center mb-3">
                      <h2 className="fw-semibold mb-0">$1,206.89</h2>
                      <div className="ms-auto">
                        <div className="dropdown">
                          <a
                            ...
                            aria-expanded="false"
                          >
                            <i className="ti ti-dots fs-4" />
                          </a>
                          <ul
                            className="dropdown-menu"
                            aria-labelledby="balance-dd"
                          >
                            <li>
                              <a className="dropdown-item" href="#">
                                <i className="ti ti-share me-1 fs-4" />
                                Share{" "}
                              </a>
                            </li>
                            <li>
                              <a className="dropdown-item" href="#">
                                <i className="ti ti-download me-1 fs-4" />
                                Download{" "}
                              </a>
                            </li>
                            <li>
                              <a className="dropdown-item" href="#">
                                <i className="ti ti-info-circle me-1 fs-4" />
                                Get Info{" "}
                              </a>
                            </li>
                          </ul>
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      <span className="text-dark fs-3 fw-bold ms-1">
                        USD 420,000
                      </span>
                      <span className="text-success fw-bold fs-3 ms-2">
                        (59,11%)
                      </span>
                    </div>
                    <button className="btn btn-light-primary text-primary w-100 mt-3">
                      {" "}
                      View Balance{" "}
                    </button>
                  </div>
        ...
        <div className="row">
          <div className="col-xl-8 d-flex align-items-strech">
            <div className="card w-100">
              <div className="card-body p-4">
                <div className="d-flex align-items-center justify-content-between">
                  <div>
                    <h5 className="card-title fw-semibold">Top NFT</h5>
                    <p className="card-subtitle mb-0">
                  ...
                  <div className="dropdown">
                    <button
                      ...
                      aria-expanded="false"
                    >
                      <i className="flag-icon flag-icon-us me-1" title="us" />{" "}
                      USD <i className="ti ti-chevron-down ms-1" />
                    </button>
                    <ul
                      className="dropdown-menu"
                    ...
                    >
                      <li>
                        <a className="dropdown-item" href="#">
                          <i
                            className="flag-icon flag-icon-us me-1"
                            title="us"
                          />{" "}
                          USD{" "}
                        </a>
                      ...
                      <li>
                        <a className="dropdown-item" href="#">
                          <i
                            className="flag-icon flag-icon-in me-1"
                            title="in"
                            id="in"
                          />{" "}
                          INR{" "}
                      ...
                      <li>
                        <a className="dropdown-item" href="#">
                          <i
                            className="flag-icon flag-icon-fr me-1"
                            title="fr"
                            id="fr"
                          />{" "}
                          FRF{" "}
                ...
                <div className="card mt-4 mb-0 shadow-none">
                  <div className="table-responsive">
                    <table className="table mb-0 align-middle text-nowrap">
                      <thead>
                        <tr>
                          <th className="ps-0">Collection</th>
                          <th>Volume</th>
                          <th>24h</th>
                          <th>Floor Price</th>
                        </tr>
                      ...
                      <tbody className="text-dark ">
                        <tr>
                          ...
                          <td>
                            <i className="cc ETH" title="ETH" /> 18,670.21
                          </td>
                          <td className="text-danger">-20.38%</td>
                          <td>$6.8k</td>
                        </tr>
                        <tr>
                          <td className="ps-0">
                          ...
                          <td>
                            <i className="cc ETH" title="ETH" /> 15,880.20
                          </td>
                          <td className="text-success">+15.14%</td>
                          <td>$5.8k</td>
                        </tr>
                        <tr>
                          <td className="ps-0">
                          ...
                          <td>
                            <i className="cc ETH" title="ETH" /> 14,920.20
                          </td>
                          <td className="text-danger">-10.25%</td>
                          <td>$5.2k</td>
                        </tr>
                      </tbody>
                    </table>
          ...
          <div className="col-xl-4 d-flex align-items-strech">
            <div className="card w-100">
              <img
                src="../../dist/images/nft/nft-bg.jpg"
                className="card-img"
                alt="nft"
              />
              <div className="p-4 mt-n4 text-center">
                ...
                <div>
                  <h6 className="mb-0 fw-semibold mt-2">The Cat X Takaish</h6>
                </div>
                <div className="d-flex align-items-center justify-content-between mt-2 pb-3 border-bottom">
                  <div className="text-start">
                    <span className="fs-3">Volume</span>
                    <h6 className="mb-0 fw-semibold">90,015.90 USD</h6>
                  </div>
                  <div className="text-end">
                    <span className="fs-3">Floor Price</span>
                    <h6 className="mb-0 fw-semibold">40.00 USD</h6>
                  </div>
                </div>
                <div className="d-flex align-items-center gap-3 pt-3">
                  <div className="round bg-light d-flex align-items-center justify-content-center rounded-circle">
                    <i className="cc ETH fs-6" />
                  </div>
                  <div>
                    <h6 className="mb-0 fw-semibold">1.23 ETH</h6>
                    <span className="fs-2">$12,000</span>
                  </div>
            ...
            <div className="card w-100">
              <div className="card-body p-4">
                <div className="d-flex align-items-center justify-content-between">
                  ...
                  <a
                    href="javascript:void(0)"
                    className="text-dark fs-6 position-relative nav-icon-hover z-index-5 text-decoration-none"
                  >
                    <i className="ti ti-dots-vertical" />
                  </a>
                </div>
                <div className="card shadow-none mb-0 mt-3">
                  ...
                  <div className="d-flex align-items-center gap-3 py-3 border-bottom">
                    <div className="round bg-light d-flex align-items-center justify-content-center rounded-circle">
                      <i className="cc BTC fs-6" />
                    </div>
                    <div>
                      <h6 className="mb-0 fw-semibold">5.23 BTC</h6>
                      <span className="fs-2">$5,000</span>
                    </div>
                    <div className="ms-auto text-end">
                  ...
                  <div className="d-flex align-items-center gap-3 py-3">
                    <div className="round bg-light d-flex align-items-center justify-content-center rounded-circle">
                      <i className="cc XRP fs-6" />
                    </div>
                    <div>
                      <h6 className="mb-0 fw-semibold">9.20 XRP</h6>
                      <span className="fs-2">$6,200</span>
                    </div>
                    <div className="ms-auto text-end">
                      <span className="text-danger">-1.0%</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="col-lg-6 d-flex align-items-strech">
            <div className="card w-100">
              <div className="card-body p-4">
                <div className="d-flex align-items-center justify-content-between">
                  <div>
                    <h5 className="card-title fw-semibold">Trending Creator</h5>
                    <p className="card-subtitle mb-0">
                ...
                <div className="card shadow-none mt-3 mb-0">
                  <div className="d-flex align-items-center gap-3 py-3 border-bottom">
                    <img
                      src="../../dist/images/profile/user-5.jpg"
                      className="rounded-circle"
                    ...
                    />
                    <div>
                      <h6 className="mb-0 fw-semibold">Project Solona</h6>
                      <span className="fs-2">12.200 Items</span>
                    </div>
                    <div className="ms-auto text-end">
                      <h6 className="mb-0 fw-semibold">$300,000+</h6>
                      <span className="fs-2">Total USD</span>
                    </div>
                  </div>
                  <div className="d-flex align-items-center gap-3 py-3 border-bottom">
                    <img
                    ...
                    />
                    <div>
                      <h6 className="mb-0 fw-semibold">The Aston Lix</h6>
                      <span className="fs-2">10.150 Items</span>
                    </div>
                    <div className="ms-auto text-end">
                      <h6 className="mb-0 fw-semibold">$250,000+</h6>
                      <span className="fs-2">Total USD</span>
                    </div>
                  </div>
                  <div className="d-flex align-items-center gap-3 py-3">
                    ...
                    />
                    <div>
                      <h6 className="mb-0 fw-semibold">Barly X Dipa</h6>
                      <span className="fs-2">10.100 Items</span>
                    </div>
                    <div className="ms-auto text-end">
                      <h6 className="mb-0 fw-semibold">$230,000+</h6>
                      <span className="fs-2">Total USD</span>
                    </div>
                  </div>
                </div>
        ...
        <div className="row">
          <div className="col-12">
            <div className="card">
              <div className="card-body p-4">
                <h5 className="card-title fw-semibold">Recent History</h5>
                <p className="card-subtitle mb-0">
                  The Impact of 9/11 on the World
                </p>
                <div className="card shadow-none mt-9 mb-0">
                  <div className="table-responsive">
                    <table className="table text-nowrap align-middle mb-0">
                      ...
                      <tbody className="text-dark ">
                        <tr>
                          <td className="ps-0 text-truncate">
                            <img
                              src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/nft/g1.webp"
                              className="rounded img-fluid me-2"
                              width={50}
                              alt="user"
                            />
                            <span className="fw-semibold">Quantum Ape</span>
                          </td>
                          <td>
                          ...
                          <td>
                            <div className="d-flex align-items-center gap-2">
                              <img
                                ...
                                className="rounded-circle"
                              />
                              <span className="fs-3">John</span>
                              <span>
                                <i className="ti ti-arrow-right text-success fs-4" />
                              </span>
                              <img
                                src="../../dist/images/profile/user-2.jpg"
                                width={25}
                                ...
                                className="rounded-circle"
                              />
                              <span className="fs-3">Deo</span>
                            </div>
                          </td>
                          <td>4</td>
                          <td>
                            <i className="cc ETH" title="ETH" /> 16 ETH
                          </td>
                          <td>13 July, 2023</td>
                          <td>
                            <div className="dropdown">
                              ...
                              >
                                <li>
                                  <a
                                    ...
                                    href="#"
                                  >
                                    <i className="ti ti-link me-1 fs-6" />
                        ...
                        <tr>
                          <td className="ps-0 text-truncate">
                            <img
                              src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/nft/g2.webp"
                              className="rounded img-fluid me-2"
                              alt="n1"
                              width={50}
                            />
                            <span className="fw-semibold">Bored Ape</span>
                          </td>
                          <td>
                          ...
                          <td>
                            <div className="d-flex align-items-center gap-2">
                              <img
                                ...
                                className="rounded-circle"
                              />
                              <span className="fs-3">Liam</span>
                              <span>
                                <i className="ti ti-arrow-left text-danger fs-4" />
                              </span>
                              <img
                                src="../../dist/images/profile/user-4.jpg"
                                width={25}
                                ...
                                className="rounded-circle"
                              />
                              <span className="fs-3">Noah</span>
                            </div>
                          </td>
                          <td>4</td>
                          <td>
                            <i className="cc ETH" title="ETH" /> 8 ETH
                          </td>
                          <td>1 Aug, 2023</td>
                          <td>
                            <div className="dropdown">
                        ...
                        <tr>
                          <td className="ps-0 text-truncate">
                            <img
                              src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/nft/g3.webp"
                              className="rounded img-fluid me-2"
                              alt="n2"
                              width={50}
                            />
                            <span className="fw-semibold">Space Ape</span>
                          </td>
                          <td>
                          ...
                          <td>
                            <div className="d-flex align-items-center gap-2">
                              <img
                                ...
                                className="rounded-circle"
                              />
                              <span className="fs-3">Oliver</span>
                              <span>
                                <i className="ti ti-arrow-left text-danger fs-4" />
                              </span>
                              <img
                                ...
                                className="rounded-circle"
                              />
                              <span className="fs-3">Elijah</span>
                            </div>
                          </td>
                          <td>4</td>
                          <td>
                            <i className="cc ETH" title="ETH" /> 9 ETH
                          </td>
                          <td>12 Jan, 2023</td>
                          <td>
                            <div className="dropdown">
                        ...
                        <tr>
                          <td className="border-0 ps-0 text-truncate">
                            <img
                              src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/nft/g4.webp"
                              className="rounded img-fluid me-2"
                              width={50}
                              alt="n1"
                            />
                            <span className="fw-semibold">Fancy Bears</span>
                          </td>
                          ...
                          <td className="border-0">
                            <div className="d-flex align-items-center gap-2">
                              <img
                                ...
                                className="rounded-circle"
                              />
                              <span className="fs-3">James</span>
                              <span>
                                <i className="ti ti-arrow-right text-success fs-4" />
                              </span>
                              <img
                                ...
                                className="rounded-circle"
                              />
                              <span className="fs-3">Lucas</span>
                            </div>
                          </td>
                          <td className="border-0">4</td>
                          <td className="border-0">
                            <i className="cc ETH" title="ETH" /> 10 ETH
                          </td>
                          <td className="border-0">1 Feb, 2023</td>
                          <td className="border-0">
                            <div className="dropdown">
                              <a
                                className="text-decoration-none"
  ...
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/index3.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:39:33 GMT */}
</>
