<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/authentication-error.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:44:20 GMT */}
  {/*  Title */}
        ...
        <div className="row justify-content-center w-100">
          <div className="col-lg-4">
            <div className="text-center">
              ...
              <a className="btn btn-primary" href="index.html" role="button">
                Go Back to Home
              </a>
            </div>
          </div>
