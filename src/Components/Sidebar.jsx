      ...
      <ul className="nav nav-pills flex-column">
        ...
        <li className="nav-item text-dark">
          ...
          <a href="/" className="nav-link text-dark fs-5 align-middle" aria-current="page">
                ...
                <img src="/images/sidebar/tasks.png" className='align-middle sidebar-icon'/>
        ...
        <li className="nav-item text-dark">
          <a href="/" className="nav-link text-dark fs-5 align-middle " aria-current="page">
                ...
                <img src="/images/sidebar/approvers.png" className='align-middle sidebar-icon'/>
        ...
        <li className="nav-item text-dark">
          <a href="/" className="nav-link text-dark fs-5 align-middle " aria-current="page">
                ...
                <img src="/images/sidebar/signatories.png" className='align-middle sidebar-icon'/>
              
              <span className="ms-3 align-middle sidebar-btn">Signatories</span>
            </a>
        </li>
        <li className="nav-item text-dark">
          <a href="/" className="nav-link text-dark fs-5 align-middle " aria-current="page">
