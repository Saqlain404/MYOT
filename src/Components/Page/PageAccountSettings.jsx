<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/page-account-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:40:23 GMT */}
  {/*  Title */}
                  ...
                  <div className="col-lg-9">
                    <div className="card">
                      <div className="card-body p-4">
                        ...
                        <p>
                          Select the notificaitons ou would like to receive via
                          ...
                          <div className="d-flex align-items-center justify-content-between mb-4">
                            <div className="d-flex align-items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="mb-0">
                                  You will be notified when customer make
                          ...
                          <div className="d-flex align-items-center justify-content-between mb-4">
                            <div className="d-flex align-items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="mb-0">
                                  You will be notified once the order is
                                  delivered
                                </p>
                              </div>
                            </div>
                          ...
                          <div className="d-flex align-items-center justify-content-between">
                            <div className="d-flex align-items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="mb-0">
                                  Turn on email notificaiton to get updates
                                  through email
                                </p>
                              </div>
                            </div>
                      ...
                      <div className="card-body p-4">
                        ...
                        <div className="d-flex align-items-center justify-content-between pb-7">
                          <p className="mb-0">
                            ...
                            elit. Corporis sapiente sunt earum officiis
                            laboriosam ut.
                          </p>
  ...
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/page-account-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:40:24 GMT */}
</>
