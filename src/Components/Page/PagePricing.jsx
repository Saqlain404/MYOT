<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/page-pricing.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:40:21 GMT */}
  {/*  Title */}
    ...
    <div className="body-wrapper">
      ...
      <div className="container-fluid">
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Pricing</h4>
        ...
        <div className="d-flex align-items-center justify-content-center my-7">
          <span className="text-dark fw-bolder text-capitalize me-3">
            Monthly
          </span>
          ...
          <span className="text-dark fw-bolder text-capitalize ms-2">
            Yearly
          </span>
        </div>
        <div className="row">
          <div className="col-sm-6 col-lg-4">
            <div className="card">
              <div className="card-body">
                ...
                <div className="my-4">
                  <img
                    src="../../dist/images/backgrounds/silver.png"
                    alt=""
                    className="img-fluid"
                    width={80}
                    height={80}
                ...
                <button className="btn btn-primary fw-bolder rounded-2 py-6 w-100 text-capitalize">
                  Choose Silver
                </button>
              </div>
            </div>
            ...
            <div className="card">
              <div className="card-body pt-6">
                <div className="text-end">
                  <span className="badge fw-bolder py-1 bg-light-warning text-warning text-uppercase fs-2 rounded-3">
                    POPULAR
                  </span>
                </div>
                <span className="fw-bolder text-uppercase fs-2 d-block mb-7">
                ...
                <div className="my-4">
                  <img
                    src="../../dist/images/backgrounds/bronze.png"
                    alt=""
                    className="img-fluid"
                    width={80}
                    height={80}
                ...
                <div className="d-flex mb-3">
                  ...
                  <span className="ms-2 fs-4 d-flex align-items-center">
                    /mo
                  </span>
                </div>
                <ul className="list-unstyled mb-7">
          ...
          <div className="col-sm-6 col-lg-4">
            <div className="card">
              <div className="card-body">
                ...
                <div className="my-4">
                  <img
                    src="../../dist/images/backgrounds/gold.png"
                    alt=""
                    className="img-fluid"
                    width={80}
                    height={80}
  ...
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/page-pricing.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:40:23 GMT */}
</>
