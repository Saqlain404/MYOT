<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/eco-shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:40:18 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
          ...
          <div className="shop-part d-flex w-100">
            ...
            <div className="card-body p-4 pb-0">
              <div className="d-flex justify-content-between align-items-center mb-4">
                ...
                <h5 className="fs-5 fw-semibold mb-0 d-none d-lg-block">
                  Products
                </h5>
