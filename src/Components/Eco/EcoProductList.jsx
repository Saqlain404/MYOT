<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/eco-product-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:40:19 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
                ...
                <table className="table align-middle text-nowrap mb-0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <p className="mb-0">Thu, Jan 12 2023</p>
                      </td>
                      <td>
                        <div className="d-flex align-items-center">
                    ...
                    <tr>
                      ...
                      <td>
                        <p className="mb-0">Thu, Jan 10 2023</p>
                      </td>
                      <td>
                        <div className="d-flex align-items-center">
                    ...
                    <tr>
                      ...
                      <td>
                        <p className="mb-0">Mon, Jan 16 2023</p>
                      </td>
                      <td>
                        <div className="d-flex align-items-center">
                          <span className="bg-success p-1 rounded-circle" />
                    ...
                    <tr>
                      ...
                      <td className="border-bottom-0">
                        <p className="mb-0">Wed, Jan 18 2023</p>
                      </td>
                      <td className="border-bottom-0">
                        <div className="d-flex align-items-center">
                          <span className="bg-danger p-1 rounded-circle" />
