<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/eco-checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:40:19 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
        ...
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Ecom-Shop</h4>
              ...
              <div className="wizard-content">
                <form action="#" className="tab-wizard wizard-circle">
                          ...
                          <tr>
                            ...
                            <td className="border-bottom-0">
                              <div className="input-group input-group-sm rounded">
                                <button
                                  className="btn minus min-width-40 py-0 border-end border-success border-end-0 text-success"
                                  type="button"
                                  id="add1"
                                >
                                ...
                                <input
                                  type="text"
                                  className="min-width-40 flex-grow-0 border border-success text-success fs-3 fw-semibold form-control text-center qty"
                                  placeholder=""
                                ...
                                />
                                <button
                                  className="btn min-width-40 py-0 border border-success border-start-0 text-success add"
                                  type="button"
                                  id="addo2"
                                >
                        ...
                        <div className="card-body p-4">
                          ...
                          >
                            <div className="position-relative col-lg-6">
                              <input
                                type="radio"
                                className="btn-check z-1 top-50 start-0 ms-4 round-16"
                                name="deliveryOpt1"
                                id="btnradio1"
                                autoComplete="off"
                                defaultChecked=""
                      ...
                      <div className="payment-option btn-group-active  card shadow-none border">
                        <div className="card-body p-4">
                          ...
                          <div className="row">
                                ...
                                <div className="position-relative col-12 mb-3">
                                  ...
                                  >
                                    <div className="d-flex align-items-center">
                                      ...
                                      <img
                                        src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/paypal.svg"
                                        alt=""
                                ...
                                <div className="position-relative col-12 mb-3">
                                  ...
                                  >
                                    <div className="d-flex align-items-center">
                                      ...
                                      <img
                                        src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/mastercard.svg"
                                        alt=""
                                        className="img-fluid ms-auto"
                                      />
                                    </div>
                            ...
                            <div className="col-lg-4">
                              <img
                                src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/products/payment.svg"
                                alt=""
                                className="img-fluid"
                              />
                            </div>
                  ...
                  <section className="payment-method text-center">
                    ...
                    <img
                      src="../../dist/images/products/payment-complete.gif"
                      alt=""
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/eco-checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:40:21 GMT */}
</>
