<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/eco-shop-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:40:18 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
        ...
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Product Detail</h4>
                ...
                <div className="col-lg-6">
                  <div id="sync1" className="owl-carousel owl-theme">
                    <div className="item rounded overflow-hidden">
                      <img
                        src="../../dist/images/products/s1.jpg"
                        alt=""
                        className="img-fluid"
                      />
                    </div>
                    <div className="item rounded overflow-hidden">
                      <img
                        src="../../dist/images/products/s2.jpg"
                        alt=""
                        className="img-fluid"
                      />
                    </div>
                    <div className="item rounded overflow-hidden">
                      <img
                        src="../../dist/images/products/s3.jpg"
                        alt=""
                        className="img-fluid"
                      />
                    </div>
                    <div className="item rounded overflow-hidden">
                      <img
                        src="../../dist/images/products/s4.jpg"
                        alt=""
                        className="img-fluid"
                      />
                    </div>
                    <div className="item rounded overflow-hidden">
                      <img
                        src="../../dist/images/products/s5.jpg"
                        alt=""
                        className="img-fluid"
                      />
                    </div>
                    <div className="item rounded overflow-hidden">
                      <img
                        src="../../dist/images/products/s6.jpg"
                        alt=""
                        className="img-fluid"
                      />
                    </div>
                    <div className="item rounded overflow-hidden">
                      <img
                        src="../../dist/images/products/s7.jpg"
                        alt=""
                        className="img-fluid"
                      />
                    </div>
                    <div className="item rounded overflow-hidden">
                      <img
                        src="../../dist/images/products/s8.jpg"
                        alt=""
                        className="img-fluid"
                      />
                    </div>
                    <div className="item rounded overflow-hidden">
                      <img
                        src="../../dist/images/products/s9.jpg"
                        alt=""
                        className="img-fluid"
                      />
                    </div>
                    <div className="item rounded overflow-hidden">
                      <img
                        src="../../dist/images/products/s10.jpg"
                        alt=""
                        className="img-fluid"
                      />
                    </div>
                    <div className="item rounded overflow-hidden">
                      <img
                        src="../../dist/images/products/s11.jpg"
                        alt=""
                        className="img-fluid"
                      />
                    </div>
                    <div className="item rounded overflow-hidden">
                      <img
                        src="../../dist/images/products/s12.jpg"
                        alt=""
                        className="img-fluid"
                      />
                    </div>
                ...
                <div className="col-lg-6">
                  <div className="shop-content">
                    ...
                    <div className="d-flex align-items-center gap-8 py-7">
                      ...
                      <a
                        className="rounded-circle d-block bg-primary p-6"
                        href="javascript:void(0)"
                      />
                    </div>
                    <div className="d-flex align-items-center gap-7 pb-7 mb-7 border-bottom">
                      ...
                      <div className="input-group input-group-sm rounded">
                        <button
                          className="btn minus min-width-40 py-0 border-end border-secondary fs-5 border-end-0 text-secondary"
                          type="button"
                          id="add1"
                        >
                        ...
                        <input
                          type="text"
                          className="min-width-40 flex-grow-0 border border-secondary text-secondary fs-4 fw-semibold form-control text-center qty"
                          placeholder=""
                        ...
                        />
                        <button
                          className="btn min-width-40 py-0 border border-secondary fs-5 border-start-0 text-secondary add"
                          type="button"
                          id="addo2"
                        >
                    ...
                    <div className="d-sm-flex align-items-center gap-3 pt-8 mb-7">
                      <a
                        href="javascript:void(0)"
                        className="btn d-block btn-primary px-5 py-8 mb-2 mb-sm-0"
                      >
                        Buy Now
                      </a>
                      <a
            ...
            <div className="card-body p-4">
              ...
              <div className="tab-content pt-4" id="pills-tabContent">
                <div
                  ...
                  tabIndex={0}
                >
                  <h5 className="fs-5 fw-semibold mb-7">
                    Sed at diam elit. Vivamus tortor odio, pellentesque eu
                    tincidunt a, aliquet sit amet lorem pellentesque eu
                  ...
                  <p className="mb-7">
                    ...
                    ipsum ut augue vestibulum malesuada. Duis vitae volutpat
                  ...
                  <p className="mb-0">
                    ...
                    ipsum. Fusce condimentum venenatis mauris et luctus.
                      ...
                      <div className="card shadow-none border w-100 mb-7 mb-lg-0">
                        <div className="card-body text-center p-4 d-flex flex-column justify-content-center">
                          ...
                          <ul className="list-unstyled d-flex align-items-center justify-content-center mb-0">
                            <li>
                              <a className="me-1" href="javascript:void(0)">
                                <i className="ti ti-star text-warning fs-6" />
                              </a>
                            </li>
                            <li>
                              <a className="me-1" href="javascript:void(0)">
                      ...
                      <div className="card shadow-none border w-100 mb-7 mb-lg-0">
                        <div className="card-body p-4 d-flex flex-column justify-content-center">
                          <div className="d-flex align-items-center gap-9 mb-3">
                            ...
                            <div
                              className="progress bg-light-primary w-100"
                              style={{ height: 4 }}
                            >
                              <div
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/eco-shop-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:40:19 GMT */}
</>
