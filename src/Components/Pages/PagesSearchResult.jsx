<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/pages-search-result.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:44:16 GMT */}
  {/*  Title */}
        ...
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Search Result</h4>
          ...
          <div className="col-12">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Search Result For "Angular Js"</h4>
                <h6 className="card-subtitle mb-5">
                  About 14,700 result ( 0.10 seconds)
                </h6>
                <ul className="search-listing list-style-none">
                  <li className="border-bottom">
                    <h4 className="mb-0 fs-5">
                      <a href="javacript:void(0)" className="">
                        AngularJs
                      </a>
                    </h4>
                    <a
                      href="javascript:void(0)"
                      className="search-links p-0 text-success"
                    >
                      http://www.google.com/angularjs
                    </a>
                    <p>
                      Lorem Ipsum viveremus probamus opus apeirian haec
                      perveniri, memoriter.Praebeat pecunias viveremus probamus
                      opus apeirian haec perveniri, memoriter.
                    </p>
                  </li>
