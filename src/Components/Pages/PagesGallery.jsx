<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/pages-gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:44:16 GMT */}
  {/*  Title */}
  ...
  <link
    rel="stylesheet"
    href="../../dist/libs/magnific-popup/dist/magnific-popup.css"
  />
  {/* Core Css */}
      ...
      <div className="container-fluid">
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Gallery</h4>
              ...
              "
                >
                  <img
                    ...
                    alt="user"
                  />
                  <div className="el-overlay w-100 overflow-hidden">
                    <ul
                      className="
                    list-style-none
                    el-info
                  ...
                  "
                    >
                      <li className="el-item d-inline-block my-0 mx-1">
                        <a
                          className="
                        btn
                        default
                        ...
                        border-white
                      "
                          href="../../dist/images/blog/blog-img1.jpg"
                        >
                          <i className="ti ti-search" />
                        </a>
                      </li>
                ...
                <div className="el-card-content text-center">
                  <h4 className="mb-0 fs-5">Project title</h4>
                  ...
                  "
                    >
                      <li className="el-item d-inline-block my-0 mx-1">
                        ...
                        border-white
                      "
                          href="../../dist/images/blog/blog-img2.jpg"
                        >
                          <i className="ti ti-search" />
                        </a>
                      </li>
                  ...
                  "
                    >
                      <li className="el-item d-inline-block my-0 mx-1">
                        ...
                        border-white
                      "
                          href="../../dist/images/blog/blog-img3.jpg"
                        >
                          <i className="ti ti-search" />
                        </a>
                      </li>
                  ...
                  "
                    >
                      <li className="el-item d-inline-block my-0 mx-1">
                        ...
                        border-white
                      "
                          href="../../dist/images/blog/blog-img4.jpg"
                        >
                          <i className="ti ti-search" />
                        </a>
                      </li>
                  ...
                  "
                    >
                      <li className="el-item d-inline-block my-0 mx-1">
                        ...
                        border-white
                      "
                          href="../../dist/images/blog/blog-img5.jpg"
                        >
                          <i className="ti ti-search" />
                        </a>
                      </li>
          ...
          <div className="col-lg-3 col-md-6">
            <div className="card overflow-hidden">
              ...
              "
                >
                  <img
                    src="../../dist/images/blog/blog-img6.jpg"
                    className="d-block position-relative w-100"
                    alt="user"
                  />
                  <div className="el-overlay w-100 overflow-hidden">
                  ...
                  "
                    >
                      <li className="el-item d-inline-block my-0 mx-1">
                        ...
                        border-white
                      "
                          href="../../dist/images/blog/blog-img6.jpg"
                        >
                          <i className="ti ti-search" />
                        </a>
                      </li>
        ...
        <div className="row mt-5">
          <div className="col-md-12">
            <h4 className="card-title">Other Gallery</h4>
            ...
            <div className="card overflow-hidden">
              ...
              "
                >
                  <a
                    className="image-popup-vertical-fit"
                    href="../../dist/images/profile/user-1.jpg"
                  >
                    <img
                      src="../../dist/images/profile/user-1.jpg"
                      className="d-block position-relative w-100"
            ...
            <div className="card overflow-hidden">
              ...
              "
                >
                  <a
                    className="image-popup-vertical-fit"
                    href="../../dist/images/profile/user-2.jpg"
                  >
                    <img
                      src="../../dist/images/profile/user-2.jpg"
                      className="d-block position-relative w-100"
  ...
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/pages-gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:44:17 GMT */}
</>
