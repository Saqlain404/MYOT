<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/pages-treeview.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:44:17 GMT */}
  {/*  Title */}
        ...
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Treeview</h4>
          ...
          <div className="col-12">
            <div className="card">
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-md-4 col-12">
                    <h4 className="card-title">Collapsed</h4>
                    <div id="treeview2" />
                  </div>
                  <div className="col-md-4 col-12">
                    <h4 className="card-title">Tags as Badges</h4>
                    <div id="treeview3" />
                  </div>
                </div>
              </div>
            ...
            <div className="card">
              <div className="card-body">
                <div className="row">
                  <div className="col-md-4 col-12">
                    <h4 className="card-title">Blue Theme</h4>
                    <div id="treeview4" />
                  </div>
                  <div className="col-md-4 col-12">
                  ...
                  <div className="col-md-4 col-12">
                    <h4 className="card-title">Expanded</h4>
                    <div id="treeview6" />
                  </div>
                </div>
              </div>
            ...
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Searchable Tree</h4>
                <div className="row">
  ...
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/pages-treeview.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:44:18 GMT */}
</>
