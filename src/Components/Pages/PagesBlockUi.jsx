<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/pages-block-ui.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:44:18 GMT */}
  {/*  Title */}
        ...
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Block-UI</h4>
        ...
        <div className="row">
            ...
            <div className="card w-100">
              <div className="card-body">
                <div className="form-group">
                  <h4 className="card-title">Block Element</h4>
          ...
          <div className="col-md-4 col-sm-12 d-flex align-items-stretch">
            <div className="card w-100">
              <div className="card-body">
                <div className="form-group">
                  <h4 className="card-title">Block Layout Area</h4>
          ...
          <div className="col-md-4 col-sm-12 d-flex align-items-stretch">
            <div className="card w-100">
              <div className="card-body">
                <div className="form-group">
                  <h4 className="card-title">Block Whole Page</h4>
          ...
          <div className="col-md-6 col-sm-12 d-flex align-items-stretch">
            <div className="card w-100">
              <div className="card-body">
                <div className="form-group">
                  <h4 className="card-title">Block Without Message</h4>
          ...
          <div className="col-md-6 col-sm-12 d-flex align-items-stretch">
            <div className="card w-100">
              <div className="card-body">
                <div className="form-group">
                  <h4 className="card-title">Block Without Overlay</h4>
          ...
          <div className="col-md-6 col-sm-12 d-flex align-items-stretch">
            <div className="card w-100">
              <div className="card-body">
                <div className="form-group">
                  <h4 className="card-title">Click Overlay To Unblock</h4>
          ...
          <div className="col-md-6 col-sm-12 d-flex align-items-stretch">
            <div className="card w-100">
              <div className="card-body">
                <div className="form-group">
                  <h4 className="card-title">Growl Notification</h4>
                ...
                "
                  ...
                  <div
                    className="growl-notification-example"
          ...
          <div className="col-md-4 col-sm-12 d-flex align-items-stretch">
            <div className="card w-100">
              <div className="card-body">
                <div className="form-group">
                  <h4 className="card-title">OnBlock Callback</h4>
          ...
          <div className="col-md-4 col-sm-12 d-flex align-items-stretch">
            <div className="card w-100">
              <div className="card-body">
                <div className="form-group">
                  <h4 className="card-title">OnUnblock Callback</h4>
                  <p>
          ...
          <div className="col-md-4 col-sm-12 d-flex align-items-stretch">
            <div className="card w-100">
              <div className="card-body">
                <div className="form-group">
                  <h4 className="card-title">OnOverlay Click Callback</h4>
