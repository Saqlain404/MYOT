      ...
      <div className="row">
        ...
        <div className="col-auto col-mg-3 min-vh-100">
          ...
          <ul className="nav nav-pills flex-column">
            ...
            >
              <Link to={"/Employee/document"} className="text-decoration-none">
                <a
                  href="/"
                  className="nav-link text-dark fs-5 align-middle"
                  aria-current="page"
            ...
            <li
              className={`"nav-item text-dark" ${
                location.pathname === "/Employee/history-log-request"
                  ? "nav_active"
                  : ""
              } `}
            >
            ...
            <li
              className={`"nav-item text-dark" ${
                location.pathname === "/Employee/received-doc"
                  ? "nav_active"
                  : ""
              } `}
            >
            ...
            >
              <Link to={"/Employee/Calender"} className="text-decoration-none">
                <a
                  href="/"
                  className="nav-link text-dark fs-5 align-middle "
                  aria-current="page"
