      ...
      <div className="row">
        ...
        <div className="col-auto col-mg-3 min-vh-100  mb-4">
          ...
          <ul className="nav nav-pills flex-column logout-margin">
            ...
            <li
              className={`"nav-item text-dark" ${
                location.pathname === "/Department/Certificate"
                  ? "nav_active"
                  : ""
              } `}
            >
              ...
              >
                ...
                >
                  <img
                    src="/images/dashboard/certificate.svg"
                    className="align-middle sidebar-icon"
                    alt=""
                  />
        ...
        <Link
          ...
          <a href="/" className="nav-link text-dark fs-5 align-middle " aria-current="page">
            ...
            <li
              className={`"nav-item text-dark" ${
                location.pathname === "/Department/Announcements"
                  ? "nav_active"
                  : ""
              } `}
            >
            ...
            <li
              className={`"nav-item text-dark" ${
                location.pathname === "/Department/My-profile"
                  ? "nav_active"
                  : ""
              } `}
            >
