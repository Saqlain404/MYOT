<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/app-email.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:40:07 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
                          ...
                          >
                            ...
                            >
                              <div className="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                                <div className="d-flex align-items-center gap-2">
                                  ...
                                  <div>
                                    ...
                                    <p className="mb-0">hello@loremipsum.com</p>
                                  </div>
                                </div>
                                <span className="badge text-bg-primary fs-2 rounded-4 py-1 px-2">
                                  Promotional
                              ...
                              <div className="border-bottom pb-7 mb-7">
                                ...
                                <p className="mb-3 text-dark">Hello Andrew,</p>
                                <p className="mb-3 text-dark">
                                  Lorem ipsum dolor sit amet, consectetur
                                  adipiscing elit. Quisque bibendum hendrerit
                                  lobortis. Nullam ut lacus eros. Sed at luctus
                                  urna, eu fermentum diam. In et tristique
                                  mauris.
                                </p>
                                <p className="mb-3 text-dark">
                                  Ut id ornare metus, sed auctor enim.
                                  Pellentesque nisi magna, laoreet a augue eget,
                            ...
                            <div className="chat-list chat" data-user-id={6}>
                              <div className="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                                <div className="d-flex align-items-center gap-2">
                                  <img
                                    src="../../dist/images/profile/user-5.jpg"
                            ...
                            <div className="chat-list chat" data-user-id={7}>
                              <div className="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                                <div className="d-flex align-items-center gap-2">
                                  <img
                            ...
                            <div className="chat-list chat" data-user-id={8}>
                              <div className="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                                <div className="d-flex align-items-center gap-2">
                                  <img
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/app-email.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:40:08 GMT */}
</>
