<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/app-notes.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:40:08 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
        ...
        <ul className="nav nav-pills p-3 mb-3 rounded align-items-center card flex-row">
          <li className="nav-item">
            <a
              ...
              id="all-category"
            >
              <i className="ti ti-list fill-white me-0 me-md-1" />
          ...
          <li className="nav-item">
            <a
              ...
              id="note-business"
            >
              <i className="ti ti-briefcase fill-white me-0 me-md-1" />
              <span className="d-none d-md-block font-weight-medium">
                Business
              </span>
            </a>
          ...
          <li className="nav-item">
            <a
              ...
              id="note-social"
            >
              <i className="ti ti-share fill-white me-0 me-md-1" />
              <span className="d-none d-md-block font-weight-medium">
                Social
              </span>
            </a>
          ...
          <li className="nav-item">
            <a
              ...
              id="note-important"
            >
              <i className="ti ti-star fill-white me-0 me-md-1" />
              <span className="d-none d-md-block font-weight-medium">
                Important
              </span>
            </a>
          ...
          <li className="nav-item ms-auto">
            <a
              ...
              id="add-notes"
            >
              <i className="ti ti-file me-0 me-md-1 fs-4" />
            ...
            <div className="col-md-4 single-note-item all-category">
              <div className="card card-body">
                ...
                <div className="d-flex align-items-center">
                  ...
                  <a
                    href="javascript:void(0)"
                    className="link text-danger ms-2"
                  >
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/app-notes.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:40:09 GMT */}
</>
