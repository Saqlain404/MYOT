<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/apps-kanban.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:40:04 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
  ...
  >
    ...
    <div className="body-wrapper">
      ...
      <div className="container-fluid">
        ...
        <div className="action-btn layout-top-spacing mb-7 d-flex align-items-center justify-content-between">
          <h5 className="mb-0 fs-5 fw-semibold">Improving Work Processes</h5>
          ...
          <div className="modal-dialog modal-dialog-centered" role="document">
            <div className="modal-content">
              <div className="modal-header">
                <h5
                  className="add-task-title modal-title"
        ...
        <div className="row scrumboard" id="cancel-row">
          <div className="col-lg-12 layout-spacing pb-3" data-simplebar="">
                    ...
                    <div data-draggable="true" className="card img-task">
                      <div className="card-body">
                        ...
                        <div className="task-content p-0">
                          <img
                            src="../../dist/images/backgrounds/kanban-img-1.jpg"
                            className="img-fluid"
                            alt="scrumboard"
                          />
                        </div>
                        <div className="task-body">
                          <div className="task-bottom">
                            ...
                            <div className="tb-section-2">
                              <span className="badge text-bg-success fs-1">
                                Design
                              </span>
                            </div>
                          </div>
                      ...
                      <div className="card-body">
                        ...
                        <div className="task-body">
                          <div className="task-bottom">
                            ...
                            <div className="tb-section-2">
                              <span className="badge text-bg-warning fs-1">
                                Development
                              </span>
                            </div>
                          </div>
                      ...
                      <div className="card-body">
                        ...
                        <div className="task-body">
                          <div className="task-bottom">
                            ...
                            <div className="tb-section-2">
                              <span className="badge text-bg-primary fs-1">
                                Mobile
                              </span>
                            </div>
                          </div>
                  ...
                  <div className="connect-sorting-content" data-sortable="true">
                    ...
                    <div data-draggable="true" className="card img-task">
                      <div className="card-body">
                        ...
                        <div className="task-content p-0">
                          <img
                            src="../../dist/images/backgrounds/kanban-img-2.jpg"
                            className="img-fluid"
                            alt="scrumboard"
                          />
                        </div>
                  ...
                  <div className="connect-sorting-content" data-sortable="true">
                    <div data-draggable="true" className="card img-task">
                      <div className="card-body">
                        ...
                        <div className="task-content p-0">
                          <img
                            src="../../dist/images/backgrounds/weatherbg.jpg"
                            className="img-fluid"
                            alt="scrumboard"
                          />
                        </div>
                        <div className="task-body">
                          <div className="task-bottom">
                            ...
                            <div className="tb-section-2">
                              <span className="badge text-bg-info fs-1">
                                Research
                              </span>
                            </div>
                          </div>
                      ...
                      <div className="card-body">
                        ...
                        <div className="task-body">
                          <div className="task-bottom">
                            ...
                            <div className="tb-section-2">
                              <span className="badge text-bg-danger fs-1">
                                Data science
                              </span>
                            </div>
                          </div>
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/apps-kanban.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:40:06 GMT */}
</>
