<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/app-chat.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:40:06 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
                ...
                >
                  <li>
                    ...
                    >
                      ...
                      <p className="fs-2 mb-0 text-muted">15 minutes</p>
                    </a>
                  </li>
                  <li>
                    <a
                    ...
                    >
                      ...
                      <p className="fs-2 mb-0 text-muted">30 minutes</p>
                    </a>
                  </li>
                  <li>
                    <a
                          ...
                          <div className="hstack gap-3 align-items-start mb-7 justify-content-start">
                            ...
                            <div>
                              ...
                              <div className="p-2 bg-light rounded-1 d-inline-block text-dark fs-3">
                                {" "}
                                If I don’t like something, I’ll stay away from
                                it.{" "}
                              </div>
                            </div>
                          </div>
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/app-chat.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:40:07 GMT */}
</>
