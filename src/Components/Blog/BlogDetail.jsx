<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/blog-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:40:18 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
            ...
            <div className="border-top mt-7 pt-7">
              ...
              <ul className="my-3 ps-4 text-dark">
                <li className="d-flex align-items-center gap-2">
                  <span className="p-1 bg-dark rounded-circle" /> Gigure out
                  what it is or
                </li>
                <li className="d-flex align-items-center gap-2">
                  <span className="p-1 bg-dark rounded-circle" /> The links it
                  currently
                </li>
                <li className="d-flex align-items-center gap-2">
                  <span className="p-1 bg-dark rounded-circle" /> It allows you
                  to start your bid
                </li>
                <li className="d-flex align-items-center gap-2">
                  <span className="p-1 bg-dark rounded-circle" /> Gigure out
        ...
        <div className="card">
          <div className="card-body">
            ...
            <div className="d-flex align-items-center gap-3 mb-4 mt-7 pt-8">
              ...
              <span className="badge bg-light-primary text-primary fs-4 fw-semibold px-6 py-8 rounded">
                3
              </span>
            </div>
            <div className="position-relative">
              <div className="p-4 rounded-2 bg-light mb-3">
                <div className="d-flex align-items-center gap-3">
                  ...
                  <span className="p-1 bg-light-dark rounded-circle d-inline-block" />
                </div>
                <p className="my-3">
                  Es do ujurus nejson imju azgudpi toceztep ji cocicoci bosawrop
                  korze ta. Casetlu udumej umocu wanaro webmos ijafa ud muli
                  amja softoj ma pijum.
                </p>
                <div className="d-flex align-items-center gap-2">
                  <a
              ...
              <div className="p-4 rounded-2 bg-light mb-3">
                ...
                <p className="my-3">
                  Huwso jewzehgu julriw niwgazep lewbob isujirmuz hemto pahop
                  cewa zuhucze rinitba etdebluj. Obdevo bo fa siztes laobeir
                  agoemugo rut sapaviw mulati do re dabelul wo tumnik wih mu.
                </p>
                <div className="d-flex align-items-center gap-2">
                  <a
                    className="text-white d-flex align-items-center justify-content-center bg-secondary p-2 fs-4 rounded-circle"
              ...
              <div className="p-4 rounded-2 bg-light mb-3 ms-7">
                <div className="d-flex align-items-center gap-3">
                  <img
                    src="../../dist/images/profile/user-3.jpg"
                    alt=""
