<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/blog-posts.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:40:15 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
        ...
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Blog app</h4>
        ...
        <div className="row">
          <div className="col-md-6 col-lg-8">
            <div
              ...
              style={{
                backgroundImage: "url(../../dist/images/blog/blog-img9.jpg)"
              }}
            >
          ...
          <div className="col-md-6 col-lg-4">
            <div
              className="card blog position-relative overflow-hidden hover-img"
              style={{
                backgroundImage: "url(../../dist/images/blog/blog-img10.jpg)"
              }}
            >
              <div className="card-body position-relative">
                <div className="d-flex flex-column justify-content-between h-100">
          ...
          <div className="col-md-6 col-lg-4">
            <div className="card rounded-2 overflow-hidden hover-img">
              <div className="position-relative">
                ...
                <span className="badge bg-white text-dark fs-2 rounded-4 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">
                  2 min Read
                </span>
                <img
                  src="../../dist/images/profile/user-1.jpg"
              ...
              <div className="card-body p-4">
                ...
                <a className="d-block my-4 fs-5 text-dark fw-semibold" href="#">
          ...
          <div className="col-md-6 col-lg-4">
            <div className="card rounded-2 overflow-hidden hover-img">
              <div className="position-relative">
                <a href="javascript:void(0)">
                  <img
                    src="../../dist/images/blog/blog-img11.jpg"
                    className="card-img-top rounded-0"
                    alt="..."
                  />
                </a>
          ...
          <div className="col-md-6 col-lg-4">
            <div className="card rounded-2 overflow-hidden hover-img">
              <div className="position-relative">
                <a href="javascript:void(0)">
                  <img
                    src="../../dist/images/blog/blog-img8.jpg"
                    className="card-img-top rounded-0"
                    alt="..."
                  />
                </a>
          ...
          <div className="col-md-6 col-lg-4">
            <div className="card rounded-2 overflow-hidden hover-img">
              ...
              <div className="card-body p-4">
                ...
                <a className="d-block my-4 fs-5 text-dark fw-semibold" href="#">
                  Apple is apparently working on a new ‘streamlined’
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/blog-posts.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:40:17 GMT */}
</>
