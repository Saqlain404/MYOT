<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-picker-material-datepicker.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:32 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
  ...
  <link
    rel="stylesheet"
    href="../../dist/libs/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css"
  />
  {/* --------------------------------------------------- */}
  {/* Core Css */}
  {/* --------------------------------------------------- */}
        ...
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">material-Datepicker</h4>
          ...
          <div className="col-12">
            ...
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Material Date picker</h4>
              </div>
              <div className="card-body">
                ...
                <div className="row">
                  <div className="col-12">
                    <label className="mt-3 font-weight-medium mb-1">
                      Default Material Date Picker
                    </label>
                    <input
                      type="text"
                      className="form-control"
                      placeholder="2023-06-04"
                      id="mdate"
                    />
                    <label className="mt-3 font-weight-medium mb-1">
                      Default Material Date Timepicker
                    </label>
                    <input
                      type="text"
                      id="date-format"
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-picker-material-datepicker.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:33 GMT */}
</>
