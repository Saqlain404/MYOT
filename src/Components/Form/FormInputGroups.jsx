<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-input-groups.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:41:56 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
  ...
  <link
    rel="stylesheet"
    href="../../dist/libs/prismjs/themes/prism-okaidia.min.css"
  />
  {/* --------------------------------------------------- */}
  {/* Core Css */}
  {/* --------------------------------------------------- */}
    ...
    <div className="body-wrapper">
      ...
      <div className="container-fluid">
        ...
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Form Input Groups</h4>
        ...
        <section>
              ...
              <div className="card w-100">
                <div className="card-body">
                  <div className="d-flex mb-3 align-items-center">
                    <div>
                      <h5 className="mb-0 fs-5">Input Addons Left</h5>
                    </div>
                    <div className="ms-auto flex-shrink-0">
                      <button
                        className="btn btn-light-primary text-primary rounded-pill text-decoration-none btn-sm"
                        title="View Code"
                        data-bs-toggle="modal"
                        data-bs-target="#view-code1-modal"
                      >
                        <i className="ti ti-code fs-5" />
                      </button>
                      {/* Code Modal */}
                      <div
                        id="view-code1-modal"
            ...
            <div className="col-md-6 col-lg-4 d-flex align-items-stretch">
              ...
              <div className="card w-100">
                <div className="card-body">
                  <div className="d-flex mb-3 align-items-center">
                    <div>
                      <h5 className="mb-0 fs-5">Input Addons Both Side</h5>
                    </div>
                    <div className="ms-auto flex-shrink-0">
                      <button
                        className="btn btn-light-primary text-primary rounded-pill text-decoration-none btn-sm"
            ...
            <div className="col-md-6 col-lg-4 d-flex align-items-stretch">
              ...
              <div className="card w-100">
                <div className="card-body">
                  <div className="d-flex mb-3 align-items-center">
                    <div>
                      <h5 className="mb-0 fs-5">Input Addons Right</h5>
                    </div>
                    <div className="ms-auto flex-shrink-0">
                      <button
                        className="btn btn-light-primary text-primary rounded-pill text-decoration-none btn-sm"
            ...
            <div className="col-md-6 col-lg-4 d-flex align-items-stretch">
              ...
              <div className="card w-100">
                <div className="card-body">
                  <div className="d-flex mb-3 align-items-center">
                    <div>
                      <h5 className="mb-0 fs-5">Input Addons Left Icon</h5>
                    </div>
                    <div className="ms-auto flex-shrink-0">
                      <button
                        className="btn btn-light-primary text-primary rounded-pill text-decoration-none btn-sm"
                            ...
                            <div className="modal-body p-4">
                              <pre className="language-html scrollable">
                                ...
                                <code>
                                  ...
                                  data-feather="file-text" class="feather-sm
                                  fill-white"&gt;&lt;/i&gt;&lt;/span&gt;{"\n"}
                                  {"            "}&lt;input type="text"
                                  class="form-control" placeholder="Username"
                                  aria-label="Username"
                  ...
                  <div className="input-group">
                    <span className="input-group-text">
                      <i className="ti ti-file-text fs-4" />
                    </span>
                    <input
                      type="text"
                      className="form-control"
            ...
            <div className="col-md-6 col-lg-4 d-flex align-items-stretch">
              ...
              <div className="card w-100">
                <div className="card-body">
                  <div className="d-flex mb-3 align-items-center">
                    <div>
                      <h5 className="mb-0 fs-5">Input Addons Both Side Icon</h5>
                    </div>
                    <div className="ms-auto flex-shrink-0">
                      <button
                        className="btn btn-light-primary text-primary rounded-pill text-decoration-none btn-sm"
                            ...
                            <div className="modal-body p-4">
                              <pre className="language-html scrollable">
                                ...
                                <code>
                                  ...
                                  {"              "}&lt;span
                                  class="input-group-text"&gt;&lt;i
                                  data-feather="trash-2" class="feather-sm
                                  fill-white"&gt;&lt;/i&gt;&lt;/span&gt;{"\n"}
                                  {"          "}&lt;/div&gt;{"\n"}
                                  {
                                    "                                                                                    "
            ...
            <div className="col-md-6 col-lg-4 d-flex align-items-stretch">
              ...
              <div className="card w-100">
                <div className="card-body">
                  <div className="d-flex mb-3 align-items-center">
                    <div>
                      <h5 className="mb-0 fs-5">Input Addons Right Icon</h5>
                    </div>
                    <div className="ms-auto flex-shrink-0">
                      <button
                        className="btn btn-light-primary text-primary rounded-pill text-decoration-none btn-sm"
          ...
          <h4 className="card-title mt-5 mb-4">Addons With Checkbox</h4>
          <div className="row">
            <div className="col-md-6 col-lg-4 d-flex align-items-stretch">
              {/* ---------------------
              ...
              <div className="card w-100">
                <div className="card-body">
                  <div className="d-flex mb-3 align-items-center">
                    <div>
                      <h5 className="mb-0 fs-5">Addons With Right Checkbox</h5>
                    </div>
                    <div className="ms-auto flex-shrink-0">
                      <button
                        className="btn btn-light-primary text-primary rounded-pill text-decoration-none btn-sm"
                            ...
                            <div className="modal-body p-4">
                              <pre className="language-html scrollable">
                                ...
                                <code>
                                  ...
                                  with checkbox"&gt;{"\n"}
                                  {"                "}&lt;button class="btn
                                  btn-light-info text-info font-medium"
            ...
            <div className="col-md-6 col-lg-4 d-flex align-items-stretch">
              ...
              <div className="card w-100">
                <div className="card-body">
                  <div className="d-flex mb-3 align-items-center">
                    <div>
                      <h5 className="mb-0 fs-5">Addons With Left Checkbox</h5>
                    </div>
                    <div className="ms-auto flex-shrink-0">
                      <button
                        className="btn btn-light-primary text-primary rounded-pill text-decoration-none btn-sm"
          ...
          <h4 className="card-title mt-5 mb-4">Addons With Radio</h4>
          <div className="row">
            <div className="col-md-6 col-lg-4 d-flex align-items-stretch">
              {/* ---------------------
              ...
              <div className="card w-100">
                <div className="card-body">
                  <div className="d-flex mb-3 align-items-center">
                    <div>
                      <h5 className="mb-0 fs-5">Addons With Left Radio</h5>
                    </div>
                    <div className="ms-auto flex-shrink-0">
                      <button
                        className="btn btn-light-primary text-primary rounded-pill text-decoration-none btn-sm"
                            ...
                            <div className="modal-body p-4">
                              <pre className="language-html scrollable">
                                ...
                                <code>
                                  ...
                                  class="form-check"&gt;{"\n"}
                                  {"                        "}&lt;input
                                  type="radio" id="customRadio6"
                                  name="customRadio"
                                  class="form-check-input"&gt;{"\n"}
                                  {"                        "}&lt;label
                                  class="form-check-label"
                                  for="customRadio6"&gt;&lt;/label&gt;{"\n"}
                                  {"                    "}&lt;/div&gt;{"\n"}
                                  {"                "}&lt;/div&gt;{"\n"}
                                  {"            "}&lt;/div&gt;{"\n"}
                                  {"        "}&lt;/form&gt;{"\n"}
                            ...
                            <div className="modal-body p-4">
                              <pre className="language-html scrollable">
                                ...
                                <code>
                                  ...
                                  class="form-check"&gt;{"\n"}
                                  {"                            "}&lt;input
                                  type="radio" id="customRadio7"
                                  name="customRadio"
                                  class="form-check-input"&gt;{"\n"}
                                  {"                            "}&lt;label
                                  class="form-check-label"
                                  for="customRadio7"&gt;&lt;/label&gt;{"\n"}
                                  {"                        "}&lt;/div&gt;{"\n"}
                                  {"                    "}&lt;/div&gt;{"\n"}
                                  {"                "}&lt;/div&gt;{"\n"}
                                  {"            "}&lt;/div&gt;{"\n"}
          ...
          <h4 className="card-title mt-5 mb-4">Addons With Buttons</h4>
          <div className="row">
            <div className="col-md-6 col-lg-4 d-flex align-items-stretch">
              {/* ---------------------
              ...
              <div className="card w-100">
                <div className="card-body">
                            ...
                            <div className="modal-body p-4">
                              <pre className="language-html scrollable">
                                ...
                                <code>
                                  ...
                                  mb-3"&gt;{"\n"}
                                  {"              "}&lt;button class="btn
                                  btn-light-danger text-danger font-medium
                                  d-flex align-items-center"
                                  type="button"&gt;&lt;i data-feather="heart"
                                  ...
                                  aria-describedby="basic-addon1"&gt;{"\n"}
                                  {"              "}&lt;button class="btn
                                  btn-light-info text-info font-medium d-flex
                                  align-items-center" type="button"&gt;&lt;i
                                  data-feather="slash" class="fill-white
                                  feather-sm
                                  me-1"&gt;&lt;/i&gt;Hate&lt;/button&gt;{"\n"}
                                  {"          "}&lt;/div&gt;{"\n"}
                                  {"        "}&lt;/form&gt;{"\n"}
                  ...
                  <form className="mt-3">
                    <div className="input-group mb-3">
                      <button
                        className="btn btn-light-danger text-danger font-medium d-flex align-items-center"
                        type="button"
                      >
                        <i className="ti ti-heart fs-4 me-1" />
                        Love
                      </button>
                      <input
                        type="text"
                      ...
                      />
                      <button
                        className="btn btn-light-info text-info font-medium d-flex align-items-center"
                        type="button"
                      >
                        <i className="ti ti-circle-half fs-4 me-1" />
                        Hate
                      </button>
                    </div>
                  </form>
                            ...
                            <div className="modal-body p-4">
                              <pre className="language-html scrollable">
                                ...
                                <code>
                                  ...
                                  class="input-group-prepend"&gt;{"\n"}
                                  {"                  "}&lt;button class="btn
                                  btn-light-info text-info" type="button"&gt;
                                  {"\n"}
                                  {"                      "}&lt;i
                                  data-feather="settings" class="fill-white
                                  feather-sm"&gt;&lt;/i&gt;{"\n"}
                                  {"                  "}&lt;/button&gt;{"\n"}
                                  {"              "}&lt;/div&gt;{"\n"}
                                  {"              "}&lt;input type="text"
                  ...
                  <form className="mt-3">
                    <div className="input-group mb-3">
                      <div className="input-group-prepend">
                        <button
                          className="btn btn-light-info text-info"
                          type="button"
                        >
                            ...
                            <div className="modal-body p-4">
                              <pre className="language-html scrollable">
                                ...
                                <code>
                                  ...
                                  {"\n"}
                                  {"                        "}&lt;i
                                  data-feather="edit-2" class="fill-white
                                  feather-sm"&gt;&lt;/i&gt;{"\n"}
                                  {"                    "}&lt;/button&gt;{"\n"}
                                  {"                "}&lt;/div&gt;{"\n"}
                                  {"                "}&lt;input type="text"
                                  ...
                                  type="button"&gt;{"\n"}
                                  {"                    "}&lt;i
                                  data-feather="trash-2" class="fill-white
                                  feather-sm"&gt;&lt;/i&gt;{"\n"}
                                  {"                "}&lt;/button&gt;{"\n"}
                                  {"            "}&lt;/div&gt;{"\n"}
                                  {"        "}&lt;/form&gt;{"\n"}
                            ...
                            <div className="modal-body p-4">
                              <pre className="language-html scrollable">
                                ...
                                <code>
                                  ...
                                  type="button"&gt;{"\n"}
                                  {"                    "}&lt;i
                                  data-feather="heart" class="fill-white
                                  feather-sm"&gt;&lt;/i&gt;{"\n"}
                                  {"                "}&lt;/button&gt;{"\n"}
                                  {"            "}&lt;/div&gt;{"\n"}
                                  {"        "}&lt;/form&gt;{"\n"}
          ...
          <h4 className="card-title mt-5 mb-4">Multiple Addons</h4>
          <div className="row">
            <div className="col-sm-12 col-md-6">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="d-flex mb-3 align-items-center">
                    <div>
                      <h5 className="mb-0 fs-5">Addons With Left Side</h5>
                    </div>
                    <div className="ms-auto flex-shrink-0">
                      <button
                        className="btn btn-light-primary text-primary rounded-pill text-decoration-none btn-sm"
            ...
            <div className="col-sm-12 col-md-6">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="d-flex mb-3 align-items-center">
                    <div>
                      <h5 className="mb-0 fs-5">Addons With Right Side</h5>
                    </div>
                    <div className="ms-auto flex-shrink-0">
                      <button
                        className="btn btn-light-primary text-primary rounded-pill text-decoration-none btn-sm"
          ...
          <h4 className="card-title mt-5 mb-4">Multiple Inputs with Addons</h4>
          <div className="row">
            <div className="col-sm-12 col-md-6">
              {/* ---------------------
              ...
              <div className="card">
                <div className="card-body">
                  <div className="d-flex mb-3 align-items-center">
                    <div>
                      <h5 className="mb-0 fs-5">Input With Right Side</h5>
                    </div>
                    <div className="ms-auto flex-shrink-0">
                      <button
                        className="btn btn-light-primary text-primary rounded-pill text-decoration-none btn-sm"
                            ...
                            <div className="modal-body p-4">
                              <pre className="language-html scrollable">
                                ...
                                <code>
                                  ...
                                  {"\n"}
                                  {"              "}&lt;span
                                  class="input-group-text"&gt;First and last
                                  name&lt;/span&gt;{"\n"}
                                  {"              "}&lt;input type="text"
                                  class="form-control"&gt;{"\n"}
                                  {"              "}&lt;input type="text"
            ...
            <div className="col-sm-12 col-md-6">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="d-flex mb-3 align-items-center">
                    <div>
                      <h5 className="mb-0 fs-5">Input With Left Side</h5>
                    </div>
                    <div className="ms-auto flex-shrink-0">
                      <button
                        className="btn btn-light-primary text-primary rounded-pill text-decoration-none btn-sm"
          ...
          <h4 className="card-title mt-5 mb-4">Button Addons</h4>
          <div className="row">
            <div className="col-sm-12 col-md-6">
              {/* ---------------------
              ...
              <div className="card">
                <div className="card-body">
                  <div className="d-flex mb-3 align-items-center">
                    <div>
                      <h5 className="mb-0 fs-5">Button With Left Side</h5>
                    </div>
                    <div className="ms-auto flex-shrink-0">
                      <button
                        className="btn btn-light-primary text-primary rounded-pill text-decoration-none btn-sm"
                            ...
                            <div className="modal-body p-4">
                              <pre className="language-html scrollable">
                                ...
                                <code>
                                  ...
                                  placeholder="Left Side" aria-label=""
                                  aria-describedby="basic-addon1"&gt;{"\n"}
                                  {
                                    "                                                                                            "
                                  }
                  ...
                  <form className="mt-3">
                    <div className="input-group">
                      <button
                        className="btn btn-light-secondary text-secondary font-medium"
                        type="button"
                      >
                        Button
                      </button>
            ...
            <div className="col-sm-12 col-md-6">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="d-flex mb-3 align-items-center">
                    <div>
                      <h5 className="mb-0 fs-5">Button With Right Side</h5>
                    </div>
                    <div className="ms-auto flex-shrink-0">
                      <button
                        className="btn btn-light-primary text-primary rounded-pill text-decoration-none btn-sm"
                            ...
                            <div className="modal-body p-4">
                              <pre className="language-html scrollable">
                                ...
                                <code>
                                  ...
                                  type="button"&gt;Button&lt;/button&gt;{"\n"}
                                  {"              "}&lt;input type="text"
                                  class="form-control" placeholder="Left Side"
                                  aria-label=""
                                  aria-describedby="basic-addon1"&gt;{"\n"}
                                  {"          "}&lt;/div&gt;{"\n"}
                                  {"        "}&lt;/form&gt;{"\n"}
          ...
          <h4 className="card-title mt-5 mb-4">Addons With Dropdown Buttons</h4>
          <div className="row">
            <div className="col-sm-12 col-md-6">
              {/* ---------------------
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <form className="mt-3">
                    <div className="input-group">
                      <button
                        className="btn btn-light-info text-info font-medium dropdown-toggle"
                        type="button"
                        data-bs-toggle="dropdown"
                        aria-haspopup="true"
                        aria-expanded="false"
                ...
                <div className="card-body">
                            ...
                            <div className="modal-body p-4">
                              <pre className="language-html scrollable">
                                ...
                                <code>
                                  ...
                                  {"\n"}
                                  {"              "}&lt;button type="button"
                                  class="btn btn-light-secondary text-secondary
                                  font-medium"&gt;Action&lt;/button&gt;{"\n"}
                                  {"              "}&lt;button type="button"
                                  class="btn btn-light-secondary text-secondary
                                  ...
                                  {"              "}&lt;input type="text"
                                  class="form-control" aria-label="Text input
                                  with segmented dropdown button"&gt;{"\n"}
                                  {"          "}&lt;/div&gt;{"\n"}
                                  {"        "}&lt;/form&gt;{"\n"}
                                  {
                                    "                                                                                    "
                  ...
                  <form className="mt-3">
                    <div className="input-group">
                      ...
                      <button
                        type="button"
                        className="btn btn-light-secondary text-secondary dropdown-toggle dropdown-toggle-split"
                        data-bs-toggle="dropdown"
                        aria-haspopup="true"
                        aria-expanded="false"
                      >
                          ...
                          <div className="modal-content">
                            <div className="modal-header border-bottom">
                              <h5
                                ...
                                id="exampleModalLabel"
                              >
                                Addons With Right Side Dropdown Segments - View
                                Code
                              </h5>
                              <button
                                type="button"
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-input-groups.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:41:57 GMT */}
</>
