<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-picker-bootstrap-rangepicker.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:31 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
  ...
  <link
    rel="stylesheet"
    href="../../dist/libs/daterangepicker/daterangepicker.css"
  />
  {/* --------------------------------------------------- */}
  {/* Core Css */}
  {/* --------------------------------------------------- */}
        ...
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Picker-Rangepicker</h4>
          ...
          <div className="col-12">
            <div className="card">
              <div className="card-body">
                ...
                <h4 className="card-title">Default Daterange Picker</h4>
                ...
                {/* Date And Time */}
                <h4 className="card-title mt-4">Date and Time</h4>
                <h6 className="card-subtitle mb-2">
                  These picker is used for when you want to choose start date to
                  end date with particuler time for both start date and end
                  date.
                </h6>
                <div className="input-group mb-3">
                  <input type="text" className="form-control datetime" />
                  <span className="input-group-text">
                    <i className="ti ti-calendar fs-5" />
                  </span>
                </div>
                {/* 24 hour Time Picker with Seconds */}
                <h4 className="card-title mt-4">Seconds with 24 hour Time</h4>
                <h6 className="card-subtitle mb-2">
                  These picker is used for when you want to choose start date to
                  end date with particuler time for both start date and end date
                  and to choose specific second from 24 hours.
                </h6>
                <div className="input-group mb-3">
                  <input type="text" className="form-control timeseconds" />
                  <span className="input-group-text">
                    <i className="ti ti-calendar fs-5" />
                  </span>
                </div>
                {/* Separate Date Picker */}
                <h4 className="card-title mt-4">Separate Date Picker</h4>
                <h6 className="card-subtitle mb-2">
                ...
                <div className="input-group mb-3">
                  <input type="text" className="form-control singledate" />
                  <span className="input-group-text">
                    <i className="ti ti-calendar fs-5" />
                  </span>
                </div>
                {/* Auto Apply Date Range */}
                <h4 className="card-title mt-4">Auto Apply Date Range</h4>
                <h6 className="card-subtitle mb-2">
                  In these picker,automatically apply a new date range as soon
                  as two dates or a predefined range is selected.
                </h6>
                <div className="input-group mb-3">
                  <input type="text" className="form-control autoapply" />
                  <span className="input-group-text">
                    <i className="ti ti-calendar fs-5" />
                  </span>
                </div>
                {/* Not Connected Calendars */}
                <h4 className="card-title mt-4">Not Connected Calenders</h4>
                <h6 className="card-subtitle mb-2">
                  In these picker,both calender are not linked with each
                  other.When both calender will disabled, the two calendars can
                  be individually advanced and display any month/year.
                </h6>
                <div className="input-group mb-3">
                  <input type="text" className="form-control linkedCalendars" />
                  <span className="input-group-text">
                    <i className="ti ti-calendar fs-5" />
                  </span>
                </div>
                {/* Date Limitation */}
                <h4 className="card-title mt-4">Limit on Date</h4>
                <h6 className="card-subtitle mb-2">
                  In these picker,maximum timespan between deadline dates.
                </h6>
                <div className="input-group mb-3">
                  <input type="text" className="form-control dateLimit" />
                  <span className="input-group-text">
                    <i className="ti ti-calendar fs-5" />
                  </span>
                </div>
                {/* With Dropdown */}
                <h4 className="card-title mt-4">With Dropdown</h4>
                <h6 className="card-subtitle mb-2">
                  In these picker,there is separate dropdown for select direct
                  month and also select year so you can easily move to
                  particuler date.
                ...
                <div className="input-group mb-3">
                  <input type="text" className="form-control showdropdowns" />
                  <span className="input-group-text">
                    <i className="ti ti-calendar fs-5" />
                  </span>
                </div>
                {/* With Week Numbers */}
                <h4 className="card-title mt-4">With Week Numbers</h4>
                <h6 className="card-subtitle mb-2">
                  In these picker,there is separate week numbers from start date
                  to end date.
                </h6>
                <div className="input-group mb-3">
                  <input type="text" className="form-control showweeknumbers" />
                  <span className="input-group-text">
                    <i className="ti ti-calendar fs-5" />
                  </span>
                </div>
                {/* Predefined Ranges */}
                <h4 className="card-title mt-4">Predefined Ranges</h4>
                <h6 className="card-subtitle mb-2">
                  In these picker,there is separate options like select today's
                  date,last 7 days,last 30 days, this month, last month and
                  custom range select as per your requirement.
                </h6>
                <div className="input-group mb-3">
                  <input type="text" className="form-control dateranges" />
                  <span className="input-group-text">
                    <i className="ti ti-calendar fs-5" />
                  </span>
                </div>
                {/* With All Show Calendar */}
                <h4 className="card-title mt-4">With All Show Calendar</h4>
                <h6 className="card-subtitle mb-2">
                  In these picker,with all above options which are mention in
                  predefined ranges- show the calendar.
                </h6>
                <div className="input-group mb-3">
                  <input type="text" className="form-control shawCalRanges" />
                  <span className="input-group-text">
                    <i className="ti ti-calendar fs-5" />
                  </span>
                </div>
                {/* Language Localization */}
                <h4 className="card-title mt-4">Language Localization</h4>
                <h6 className="card-subtitle mb-2">
                  In these picker,change he language of calendar.
                </h6>
                <div className="input-group mb-3">
                  <input type="text" className="form-control localeRange" />
                  <span className="input-group-text">
                    <i className="ti ti-calendar fs-5" />
                  </span>
                </div>
                {/* Open Picker on top */}
                <h4 className="card-title mt-4">Open Picker on top</h4>
                <h6 className="card-subtitle mb-2">
                  In these picker,calendar will open on top of the form-control.
                </h6>
                <div className="input-group mb-3">
                  <input type="text" className="form-control drops" />
                  <span className="input-group-text">
                    <i className="ti ti-calendar fs-5" />
                  </span>
                </div>
                {/* Custom Button Options */}
                <h4 className="card-title mt-4">Custom Button Options</h4>
                <h6 className="card-subtitle mb-2">
                  In these picker,you can add your button options or style.
                </h6>
                <div className="input-group mb-3">
                  <input type="text" className="form-control buttonClass" />
                  <span className="input-group-text">
                    <i className="ti ti-calendar fs-5" />
                  </span>
                </div>
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-picker-bootstrap-rangepicker.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:32 GMT */}
</>
