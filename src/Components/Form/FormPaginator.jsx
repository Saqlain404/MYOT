<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-paginator.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:04 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
  ...
  <link
    rel="stylesheet"
    href="../../dist/libs/bootstrap-datepaginator/dist/bootstrap-datepaginator.min.css"
  />
  {/* --------------------------------------------------- */}
  {/* Core Css */}
  {/* --------------------------------------------------- */}
        ...
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Paginator</h4>
          ...
          <div className="col-sm-12">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Date Paginator</h4>
                <h5 className="card-subtitle">
                  A jQuery plugin which takes Twitter Bootstrap's already great
                  pagination component and injects a bit of date based magic. In
                  the process creating a hugely simplified and modularised way
                  of paging date based results in your application.
                </h5>
                <h4 className="card-title mt-5">Default:</h4>
                <div id="paginator1" />
                <h4 className="card-title mt-5">Large:</h4>
                <div id="paginator2" />
                <h4 className="card-title mt-5">Small:</h4>
                <div id="paginator3" />
                <h4 className="card-title mt-5">Onselect:</h4>
                <div id="paginator4" />
              </div>
            </div>
          </div>
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-paginator.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:05 GMT */}
</>
