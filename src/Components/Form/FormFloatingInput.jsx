<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-floating-input.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:53 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
        ...
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Floating-Input</h4>
            ...
            <div className="card">
              <div className="card-body">
                ...
                <form className="floating-labels mt-4">
                  <div className="form-group mb-5 focused">
                    <input type="text" className="form-control" id="input1" />
                    <span className="bar" />
                    <label htmlFor="input1">Regular Input</label>
                  </div>
                  ...
                  <div className="form-group mb-5">
                    ...
                    <span className="bar" />
                    <label htmlFor="input3">Placeholder</label>
                  </div>
                  <div className="form-group mb-5">
                    <input type="text" className="form-control" id="input4" />
                    <span className="bar" />
                    <label htmlFor="input4">Helping text</label>
                  ...
                  <div className="form-group mb-5">
                    ...
                    />
                    <span className="bar" />
                    <label htmlFor="input5">Input with tooltip</label>
                  </div>
                  <div className="form-group mb-5">
                    ...
                    <span className="bar" />
                    <label htmlFor="input6">Gender</label>
                  </div>
                  <div className="form-group mb-1">
                    ...
                    />
                    <span className="bar" />
                    <label htmlFor="input7">Text area</label>
                  </div>
                </form>
              </div>
            </div>
              ...
              <div className="card-body">
                ...
                <form className="floating-labels mt-4">
                  <div className="form-group mb-5">
                    ...
                    />
                    <span className="bar" />
                    <label htmlFor="input8">Large Input</label>
                  </div>
                  <div className="form-group mb-5">
                    <input
                      type="text"
                    ...
                    />
                    <span className="bar" />
                    <label htmlFor="input9">Small Input</label>
                  </div>
                  <div className="form-group has-warning mb-5">
                    <input type="text" className="form-control" id="input10" />
                    <span className="bar" />
                    <label htmlFor="input10">Warning State</label>
                  </div>
                  <div className="form-group has-success mb-5">
                    <input type="text" className="form-control" id="input11" />
                    <span className="bar" />
                    <label htmlFor="input11">Success State</label>
                  </div>
                  <div className="form-group has-error has-danger mb-5">
                    <input type="text" className="form-control" id="input12" />
                    <span className="bar" />
                    <label htmlFor="input12">Error State</label>
                  </div>
                  <div className="form-group has-warning has-feedback mb-5">
                    <input
                      type="text"
                    ...
                    />
                    <span className="bar" />
                    <label htmlFor="input13">Warning State With Feedback</label>
                  </div>
                  <div className="form-group has-success has-feedback mb-5">
                    <input
                      type="text"
                    ...
                    />
                    <span className="bar" />
                    <label htmlFor="input14">Success State With Feedback</label>
                  </div>
                  <div className="form-group has-danger has-error has-feedback mb-1">
                    <input
                      type="text"
                    ...
                    />
                    <span className="bar" />
                    <label htmlFor="input15">Error State With Feedback</label>
                  </div>
                </form>
              </div>
            </div>
