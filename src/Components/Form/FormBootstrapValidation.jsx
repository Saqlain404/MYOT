<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-bootstrap-validation.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:14 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
        ...
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Bootstrap-Validation</h4>
          ...
          <div className="col-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Browser default Validation</h4>
              </div>
            ...
            <div className="card">
              ...
              <div className="card-body">
                <form className="needs-validation" noValidate="">
                  ...
                  <button
                    className="btn btn-info mt-3 rounded-pill px-4"
                    type="submit"
                  >
                    Submit form
                  </button>
            ...
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Server side Validation</h4>
              </div>
              <div className="card-body">
                <form>
                  <div className="row">
            ...
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Validation with Tooltips</h4>
              </div>
              <div className="card-body">
                <form className="needs-validation" noValidate="">
                  <div className="row">
                  ...
                  <button
                    className="btn btn-info rounded-pill px-4 mt-4"
                    type="submit"
                  >
                    Submit form
                  </button>
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-bootstrap-validation.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:15 GMT */}
</>
