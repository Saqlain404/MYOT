<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-bordered.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:47 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
        ...
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Bordered</h4>
                ...
                <form className="form-horizontal r-separator">
                  <div className="card-body">
                    ...
                    <div className="form-group row align-items-center mb-0">
                      <label
                        htmlFor="inputEmail3"
                        className="col-3 text-end control-label col-form-label"
                      >
                        First Name
                      </label>
                    ...
                    <div className="row border-bottom">
                      <div className="col-sm-12 col-lg-6">
                        <div className="form-group row align-items-center mb-0">
                          ...
                          <div className="col-9 border-start pt-2 pb-2">
                            <input
                              type="text"
                              className="form-control"
                              id="inputEmail3"
