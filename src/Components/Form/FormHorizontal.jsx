<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-horizontal.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:42 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
      ...
      <div className="container-fluid">
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Horizontal Form</h4>
        ...
        <div className="row">
          <div className="col-lg-6">
            <div className="card">
              <div className="px-4 py-3 border-bottom">
                <h5 className="card-title fw-semibold mb-0">Basic Layout</h5>
              </div>
              <div className="card-body p-4">
                <div className="mb-4 row align-items-center">
                  <label
                    htmlFor="exampleInputPassword1"
                    className="form-label fw-semibold col-sm-3 col-form-label"
                  >
                    Name
                  </label>
                  ...
                  <div className="col-sm-9">
                    <div className="input-group border rounded-1">
                      <span
                        ...
                        id="basic-addon1"
                      >
                        <i className="ti ti-building-arch fs-6" />
                      </span>
                      <input
                        type="text"
                        className="form-control border-0 ps-2"
                  ...
                  <div className="col-sm-9">
                    <div className="input-group border rounded-1">
                      <span
                        ...
                        id="basic-addon1"
                      >
                        <i className="ti ti-message-2 fs-6" />
                      </span>
                      <textarea
                        className="form-control p-7 border-0 ps-2"
                        name=""
                        id=""
                        cols={20}
                        rows={1}
          ...
          <div className="col-lg-6">
            <div className="card">
              <div className="px-4 py-3 border-bottom">
                <h5 className="card-title fw-semibold mb-0">Form Separator</h5>
              </div>
            ...
            <div className="card">
              ...
              <div className="card-body p-4 border-bottom">
                ...
                <div className="mb-4 row align-items-center">
                  <label
                    htmlFor="exampleInputPassword1"
                    className="form-label fw-semibold col-sm-3 col-form-label text-end"
                  >
                    Username
                  </label>
                  <div className="col-sm-9">
        ...
        <div className="collapsible-section mb-4">
          <h5 className="card-title fw-semibold mb-4">Collapsible Section</h5>
          <div
            className="accordion accordion-flush position-relative overflow-hidden"
            id="accordionFlushExample"
          >
            <div className="accordion-item mb-3 shadow-none border rounded-top">
              <h2 className="accordion-header" id="flush-headingOne">
                <button
                  className="accordion-button collapsed fs-4 fw-semibold px-3 py-6 lh-base border-0 rounded-top"
                  type="button"
                  data-bs-toggle="collapse"
              ...
              >
                <div className="accordion-body px-3 fw-normal">
                  <div className="row">
                    <div className="col-lg-6">
                      <div className="mb-4 row align-items-center">
                        <label
                      ...
                      <div className="mb-4 row align-items-center">
                        ...
                        <div className="col-sm-9">
                          <div className="input-group border rounded-1">
                            <textarea
                              className="form-control p-7 border-0"
                              name=""
                              id=""
                              cols={20}
                              rows={1}
                      ...
                      <div className="row">
                        ...
                        <div className="col-sm-9">
                          <div className="form-check d-flex align-items-center gap-2 mb-8">
                            <input
            ...
            <div className="accordion-item mb-3 shadow-none border">
              <h2 className="accordion-header" id="flush-headingTwo">
                <button
                  className="accordion-button collapsed fs-4 fw-semibold px-3 py-6 lh-base border-0"
                  type="button"
                  data-bs-toggle="collapse"
            ...
            <div className="accordion-item mb-3 shadow-none border rounded-bottom">
              <h2 className="accordion-header" id="flush-headingThree">
                <button
                  className="accordion-button collapsed fs-4 fw-semibold px-3 py-6 lh-base border-0 rounded-bottom"
                  type="button"
                  data-bs-toggle="collapse"
                        ...
                        <div className="col-lg-3">
                          <div className="mb-4">
                            ...
                            <div className="input-group border rounded-1">
                              ...
                              />
                              <span
                                className="input-group-text bg-transparent px-6"
                                id="basic-addon1"
                              >
                                <i className="ti ti-help fs-6" />
                              </span>
                            </div>
                          </div>
                        </div>
        ...
        <div className="form-with-tabs">
          <h5 className="card-title fw-semibold mb-4">Form with Tabs</h5>
          <div className="card">
            <ul
            ...
            >
              <li className="nav-item" role="presentation">
                <button
                  className="nav-link position-relative rounded-0 active d-flex align-items-center justify-content-center bg-transparent fs-3 py-6 fw-bold"
                  id="pills-personal-info-tab"
                  data-bs-toggle="pill"
                  data-bs-target="#pills-personal-info"
                  type="button"
                  role="tab"
                  aria-controls="pills-personal-info"
                  aria-selected="true"
                >
                  {" "}
                  Personal Info{" "}
              ...
              <li className="nav-item" role="presentation">
                <button
                  className="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-6 fw-bold"
                  id="pills-account-details-tab"
                  data-bs-toggle="pill"
                  data-bs-target="#pills-account-details"
                  type="button"
                  role="tab"
                  aria-controls="pills-account-details"
                  aria-selected="false"
                >
                  {" "}
                  Account Details{" "}
            ...
            <div className="card-body p-4">
              <div className="tab-content" id="pills-tabContent">
                ...
                <div
                  ...
                  id="pills-account-details"
                  role="tabpanel"
                  aria-labelledby="pills-account-details-tab"
                  tabIndex={0}
                >
                  <div className="row">
                    <div className="col-lg-6">
