<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-striped-row.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:53 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
        ...
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Striped-Row</h4>
        ...
        <div className="row">
          <div className="col-12">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Project Assinging</h4>
                <h6 className="card-subtitle">
                  Add{" "}
                  <mark>
                    <code>.striped-rows</code>
                  </mark>{" "}
                  class in the form with bordered form styling.
                </h6>
              </div>
          ...
          <div className="row">
            <div className="col-12">
              <div className="card">
                <div className="card-body">
                  <h4 className="card-title">Employee Timing</h4>
                  <h6 className="card-subtitle">
                    Add{" "}
                    <mark>
                      <code>.striped-rows</code>
                  ...
                  <div className="card-body">
                    ...
                    <div className="form-group row">
                      ...
                      <div className="col-9">
                        <div className="input-group">
                          <span className="input-group-text" id="basic-addon1">
                            <i className="ti ti-briefcase fs-5" />
                          </span>
                          <input
                            type="text"
                            className="form-control"
                    ...
                    <div className="form-group row">
                      ...
                      <div className="col-9">
                        <div className="input-group">
                          <span className="input-group-text" id="basic-addon1">
                            <i className="ti ti-message-circle fs-5" />
                          </span>
                          <input
                            type="date"
                            className="form-control"
                    ...
                    <div className="form-group row">
                      ...
                      <div className="col-9">
                        <div className="input-group">
                          <span className="input-group-text" id="basic-addon1">
                            <i className="ti ti-clock-hour-4 fs-5" />
                          </span>
                          <input
                            type="time"
                            className="form-control"
