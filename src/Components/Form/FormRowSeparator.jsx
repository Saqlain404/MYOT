<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-row-separator.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:42 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-subtitle mb-0">
                    ...
                    class in the form with form styling.
                  </p>
                </div>
                <form className="form-horizontal r-separator">
                  <div className="card-body">
                    <h5>Personal Info</h5>
                    <div className="form-group mb-3 row pb-3">
                      <label
                        htmlFor="inputEmail3"
                  ...
                  <div className="card-body bg-light">
                    <h4 className="card-title mt-2 pb-3">Requirements</h4>
                    <div className="form-group mb-3 row pb-3">
                      <label
                        htmlFor="inputEmail3"
                        className="col-sm-3 text-end control-label col-form-label"
              ...
              <div className="card">
                ...
                <form className="form-horizontal r-separator">
                  <div className="card-body">
                    ...
                    <div className="row">
                      <div className="col-sm-12 col-lg-6">
                        <div className="form-group mb-3 row pt-3">
                          <label
                            htmlFor="inputEmail3"
                            className="col-sm-3 text-end control-label col-form-label"
                          >
          ...
          <div className="row">
            <div className="col-12">
              ...
              <div className="card">
                ...
                <form className="form-horizontal r-separator border-top">
                  <div className="card-body">
                    <div className="form-group mb-3 row pb-3">
                      <label
                        htmlFor="inputEmail3"
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-row-separator.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:43 GMT */}
</>
