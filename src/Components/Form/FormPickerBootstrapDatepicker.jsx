<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-picker-bootstrap-datepicker.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:32 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
        ...
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Picker-Datepicker</h4>
                ...
                <div className="row">
                  <div className="col-12">
                    <div className="example">
                      <h4 className="card-title">Default Datedpicker</h4>
                      <h6 className="card-subtitle mb-2">
                        just add class <code>.mydatepicker</code> to create it.
                      </h6>
                    ...
                    <div className="example">
                      <h4 className="card-title mt-4">Autoclose Datedpicker</h4>
                      <h6 className="card-subtitle mb-2">
                    ...
                    <div className="example">
                      <h4 className="card-title mt-4">Date Range picker</h4>
                      <h6 className="card-subtitle mb-2">
                      ...
                      >
                        <input
                          ...
                          name="start"
                        />
                        <span className="input-group-text bg-info b-0 text-white">
                          TO
                        </span>
                        <input
                          type="text"
                  ...
                  <div className="col-12">
                    <div className="">
                      <h4 className="card-title mt-4">Datepicker Inline</h4>
                      <h6 className="card-subtitle mb-2">
