<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-editor-ckeditor.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:33 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
  ...
  <link
    rel="stylesheet"
    href="../../dist/libs/ckeditor/samples/toolbarconfigurator/lib/codemirror/neo.css"
  />
  <link
    rel="stylesheet"
    href="../../dist/libs/ckeditor/samples/css/samples.css"
  />
  {/* --------------------------------------------------- */}
  {/* Core Css */}
  {/* --------------------------------------------------- */}
      ...
      <div className="container-fluid">
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Ck Editor</h4>
        ...
        <div className="row">
          <div className="col-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Basic Preset Ck Editor</h4>
              </div>
          ...
          <div className="col-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Standard Preset Ck Editor</h4>
              </div>
              <div className="card-body">
                <textarea
                  cols={80}
          ...
          <div className="col-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Full Preset Ck Editor</h4>
              </div>
              <div className="card-body">
                <textarea
                  cols={80}
          ...
          <div className="col-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Toolbar Location Ck Editor</h4>
              </div>
              <div className="card-body">
                <textarea
                  cols={80}
          ...
          <div className="col-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Spelling Checker Ck Editor</h4>
              </div>
              <div className="card-body">
                <div id="editor">
                  <h6>Hello...This is Test Text......!</h6>
            ...
            <div className="card">
              ...
              <div className="card-body">
                <h6 className="card-subtitle">
                  CKEditor is an Open source application, which means it can be
                  modified in any way you want. It benefits from an active
          ...
          <div className="col-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Inline Editor</h4>
              </div>
              <div className="card-body">
                <div className="border p-3">
                  ...
                  >
                    <p>
                      This
                      <a href="https://docs.ckeditor.com/ckeditor4/docs/#!/guide/dev_inline">
                        inline editor
                      </a>
                      instance is using the&nbsp;
                      <a href="https://ckeditor.com/cke4/addon/sourcedialog">
                        Source Dialog
                      </a>
                      &nbsp;plugin for source editing.
                    </p>
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-editor-ckeditor.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:35 GMT */}
</>
