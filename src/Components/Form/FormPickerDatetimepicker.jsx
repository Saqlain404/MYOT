<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-picker-datetimepicker.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:25 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
  ...
  <link
    rel="stylesheet"
    href="../../dist/libs/pickadate-jalaali/lib/themes/default.css"
  />
  <link
    rel="stylesheet"
    href="../../dist/libs/pickadate-jalaali/lib/themes/default.date.css"
  />
  <link
    rel="stylesheet"
    href="../../dist/libs/pickadate-jalaali/lib/themes/default.time.css"
  />
  {/* --------------------------------------------------- */}
  {/* Core Css */}
  {/* --------------------------------------------------- */}
      ...
      <div className="container-fluid">
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Picker-Datetimepicker</h4>
          ...
          <div className="col-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Pickadate Picker</h4>
              </div>
              <div className="card-body">
                ...
                <div className="mb-4">
                  <label className="font-weight-medium mb-1 fs-4 text-dark">
                    Default Pickadate
                  </label>
                  <h6 className="card-subtitle mb-3">
                  ...
                  <div className="input-group">
                    <span className="input-group-text">
                      <i className="ti ti-calendar fs-5" />
                    </span>
                    <input
                      type="text"
                ...
                <div className="mb-4">
                  ...
                  <div className="input-group">
                    ...
                    <input
                      type="text"
                      className="form-control pickadate-clear-buttons"
                ...
                <div className="mb-4">
                  ...
                  <div className="input-group">
                    ...
                    <input
                      type="text"
                      className="form-control pickadate-select-year"
                ...
                <div className="mb-4">
                  ...
                  <h6 className="card-subtitle mb-3">
                    To use add <code>.pickadate-firstweek</code> class to change
                    first weekday to Monday.
                  </h6>
                  <div className="input-group">
                    <span className="input-group-text">
                      <i className="ti ti-calendar fs-5" />
                    ...
                    <input
                      type="text"
                      className="form-control pickadate-firstweek"
                ...
                <div className="mb-4">
                  ...
                  <div className="input-group">
                    ...
                    <input
                      type="text"
                      className="form-control pickadate-datelimits"
                ...
                <div className="mb-4">
                  ...
                  <div className="input-group">
                    ...
                    <input
                      type="text"
                      className="form-control pickadate-change-format"
                ...
                <div className="mb-4">
                  ...
                  <div className="input-group">
                    ...
                    <input
                      type="text"
                      className="form-control pickadate-changearrow"
                      placeholder="Change Formats"
                    />
                  </div>
                </div>
                <div className="mb-4">
                  ...
                  <div className="input-group">
                    <input
                      type="text"
                      className="form-control pickadate-disable-arbitrarydates"
                ...
                <div className="mb-4">
                  ...
                  <div className="input-group">
                    <input
                      type="text"
                      className="form-control pickadate-disable-week"
                ...
                <div className="mb-4">
                  ...
                  <h6 className="card-subtitle mb-3">
                    To use add <code>.pickadate-minmax</code> class for minimum
                    and maximum date range.
                  </h6>
                  <div className="input-group">
                    <input
                      type="text"
                      className="form-control pickadate-minmax"
                ...
                <div className="mb-4">
                  ...
                  <h6 className="card-subtitle mb-3">
                    To use add <code>.pickadate-monyear-dropdown</code> class to
                    set select to month and year from the drodown.
                  </h6>
                  <div className="input-group">
                    <input
                      type="text"
                      className="form-control pickadate-monyear-dropdown"
                ...
                <div className="mb-4">
                  ...
                  <div className="input-group">
                    <input
                      type="text"
                      className="form-control pickadate-events"
                ...
                <div className="mb-4">
                  <label className="font-weight-medium mb-1 fs-4 text-dark">
                    Native calendar of Disable picker
                  </label>
                  <h6 className="card-subtitle mb-3">
        ...
        <div className="row">
          <div className="col-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Pickatime Picker</h4>
              </div>
              <div className="card-body">
                <div className="mb-4">
                  <label className="font-weight-medium mb-1 fs-4 text-dark">
                ...
                <div className="mb-4">
                  ...
                  <div className="input-group">
                    ...
                    <input
                      type="text"
                      className="form-control pickatime-minmax-range"
                ...
                <div className="mb-4">
                  ...
                  <h6 className="card-subtitle mb-3">
                    To use <code>.pickatime-format-label</code> class to display
                    time label format.
                  </h6>
                  <div className="input-group">
                    <span className="input-group-text">
                    ...
                    <input
                      type="text"
                      className="form-control pickatime-format-label"
                ...
                <div className="mb-4">
                  ...
                  <div className="input-group">
                    ...
                    <input
                      type="text"
                      className="form-control pickatime-formatTime-display"
                ...
                <div className="mb-4">
                  ...
                  <div className="input-group">
                    ...
                    <input
                      type="text"
                      className="form-control pickatime-time-limits"
                ...
                <div className="mb-4">
                  <label className="font-weight-medium mb-1 fs-4 text-dark">
                    Disable set of time using Object
                  </label>
                  <h6 className="card-subtitle mb-3">
                    To use add
                  ...
                  <div className="input-group">
                    <input
                      type="text"
                      className="form-control pickatime-timedisable-object"
                ...
                <div className="mb-4">
                  <label className="font-weight-medium mb-1 fs-4 text-dark">
                    Disable set of time using Integers
                  </label>
                  <h6 className="card-subtitle mb-3">
                    To use add
                    <code>.pickatime-timedisable-integer</code> class and using
                    integers as hours (0 to 23)
                  </h6>
                  <div className="input-group">
                    <input
                      type="text"
                      className="form-control pickatime-timedisable-integer"
                ...
                <div className="mb-4">
                  ...
                  <div className="input-group">
                    <input
                      type="text"
                      className="form-control pickatime-disable-all"
                ...
                <div className="mb-4">
                  ...
                  <h6 className="card-subtitle mb-3">
                    ...
                    and use for When a time is selected or the "clear" button is
                    pressed, the picker closes.
                  </h6>
                  <div className="input-group">
                    <input
                      type="text"
                      className="form-control pickatime-closeuser-action"
                ...
                <div className="mb-4">
                  ...
                  <h6 className="card-subtitle mb-3">
                    To use add just <code>pickatime-events</code> and to verify
                    open console.
                  </h6>
                  <div className="input-group">
                    <input
                      type="text"
                      className="form-control pickatime-events"
                      placeholder="Open console to verify events"
                    />
                    <span className="input-group-text">
                      <i className="ti ti-alarm fs-5" />
        ...
        <div className="row">
          <div className="col-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">With API</h4>
              </div>
              <div className="card-body">
                <div className="mb-4">
                  <label className="font-weight-medium mb-1 fs-4 text-dark">
                ...
                <div className="mb-4">
                  <label className="font-weight-medium mb-1 fs-4 text-dark">
                    Clear the Date With Inline Button
                  </label>
                  <div className="input-group">
                    <input
                      type="text"
                      className="datepicker form-control"
                      id="api_picker_clear_b"
                      defaultValue="15 October, 2010"
                      data-value="2012-10-15"
                    />
                    <button
                      className="btn btn-outline-danger input-clear"
                      id="api_button_clear_b"
                      type="button"
                    >
                      <i className="ti ti-circle-x-filled fs-5" />
                    </button>
                  </div>
                </div>
              </div>
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-picker-datetimepicker.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:31 GMT */}
</>
