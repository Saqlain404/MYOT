<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-bootstrap-switch.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:00 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
  ...
  <link
    rel="stylesheet"
    href="../../dist/libs/bootstrap-switch/dist/css/bootstrap3/bootstrap-switch.min.css"
  />
  {/* --------------------------------------------------- */}
  {/* Core Css */}
  {/* --------------------------------------------------- */}
          ...
          <div className="row">
            ...
            <div className="col-lg-6 d-flex align-items-stretch">
              ...
              <div className="card w-100">
                <div className="card-body">
                  <div className="mb-3">
                    <h5 className="card-title mb-0">Bootstrap Switch - Size</h5>
                  </div>
                  <p className="mb-3 card-subtitle">
                    Just add
                    <mark>
                      <code>data-size="Size"</code>
                    </mark>{" "}
                    attribute to the
                    <mark>
                    ...
                    . Size values:
                    <mark>
                      <code>mini, small, normal, large</code>
                    </mark>
                    .
                  </p>
                  <div className="mb-4 bt-switch">
                    <input type="checkbox" defaultChecked="" data-size="mini" />
                    <input
                      type="checkbox"
                      defaultChecked=""
                      data-size="small"
              ...
              <div className="card w-100">
                <div className="card-body">
                  ...
                  <p className="mb-3 card-subtitle">
                    Just add
                    <mark>
                      <code>data-on-color="Color"</code>
                    </mark>{" "}
                    &amp;
                    <mark>
                      <code>data-off-color="Color"</code>
                    </mark>{" "}
                    to the
                    <mark>
                      <code>&lt;input type="checkbox"...&gt;</code>
              ...
              <div className="card w-100">
                <div className="card-body">
                  ...
                  <p className="mb-3 card-subtitle">
                    Just add
                    <mark>
                      <code>data-on-text="Text"</code>
                    </mark>{" "}
                    &amp;
                    <mark>
                      <code>data-off-text="Text"</code>
                    </mark>{" "}
                    to the
                    <mark>
                      <code>&lt;input type="checkbox"...&gt;</code>
              ...
              <div className="card w-100">
                <div className="card-body">
                  ...
                  <p className="mb-3 card-subtitle">
                    Just add
                    <mark>
                      <code>data-on-text="Long Text"</code>
                    </mark>{" "}
                    &amp;
                    <mark>
                      <code>data-off-text="Long Text"</code>
                    </mark>{" "}
                    to the
                    <mark>
                      <code>&lt;input type="checkbox"...&gt;</code>
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-bootstrap-switch.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:01 GMT */}
</>
