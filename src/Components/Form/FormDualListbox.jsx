<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-dual-listbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:02 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
  ...
  <link
    rel="stylesheet"
    href="../../dist/libs/bootstrap-duallistbox/dist/bootstrap-duallistbox.min.css"
  />
  {/* --------------------------------------------------- */}
  {/* Core Css */}
  {/* --------------------------------------------------- */}
            ...
            <div className="col-12">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="mb-3">
                    <h5 className="card-title mb-0">Basic Dual ListBox</h5>
                  </div>
                  ...
                  <select multiple="multiple" size={10} className="duallistbox">
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-subtitle mb-3">
                    Add{" "}
                    <mark>
                      <code>.duallistbox-no-filter</code>
                    </mark>{" "}
                    class without filter dual listbox.
                  </p>
                  <select
                    multiple="multiple"
                    size={10}
                    className="duallistbox-no-filter"
                  >
                    <option value={1}>Amsterdam</option>
                    <option value={2}>Antwerp</option>
                    <option value={3} selected="selected">
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-subtitle mb-3">
                    Add
                    <mark>
                      <code>.duallistbox-with-filter</code>
                    </mark>{" "}
                    class for basic dual listbox.
                  </p>
                  <select
                    multiple="multiple"
                    size={10}
                    className="duallistbox-with-filter"
                  >
                    <option value={1}>Amsterdam</option>
                    <option value={2}>Antwerp</option>
                    <option value={3} selected="selected">
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-subtitle mb-3">
                    Add
                    <mark>
                      <code>.duallistbox-multi-selection</code>
                    </mark>
                  ...
                  <select
                    multiple="multiple"
                    size={10}
                    className="duallistbox-multi-selection"
                  >
                    <option value={1}>Amsterdam</option>
                    <option value={2}>Antwerp</option>
                    <option value={3} selected="selected">
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-subtitle mb-3">
                    ...
                    <mark>
                      <code>
                        filterTextClear, filterPlaceHolder, infoText,
                        infoTextFiltered, infoTextEmpty
                      </code>
                    </mark>
                    . You can use custom language also.
                  </p>
                  <select
                    multiple="multiple"
                    size={10}
                    className="duallistbox-custom-text"
                  >
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-subtitle mb-3">
                    Use
                    <mark>
                      <code>selectorMinimalHeight</code>
                    </mark>{" "}
                    setting option to set dual listbox custom height.
                  </p>
                  <select
                    multiple="multiple"
                    size={10}
                    className="duallistbox-custom-height"
                  >
                    <option value={1}>Amsterdam</option>
                    <option value={2}>Antwerp</option>
                    <option value={3} selected="selected">
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-subtitle mb-3">
                    ...
                    button. Add an option and also clearing highlights of
                    listbox option using
                    <mark>
                      <code>Add with clearing highlight</code>
                    </mark>
                    button
                  </p>
                  <select
                  ...
                  <div className="buttons block mt-3">
                    <button
                      type="button"
                      className="btn btn-light-info text-info rounded-pill font-medium duallistbox-add"
                    >
                      Add options
                    </button>
                    <button
                      type="button"
                      className="btn btn-light-info text-info rounded-pill font-medium duallistbox-add-clear"
                    >
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-dual-listbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:03 GMT */}
</>
