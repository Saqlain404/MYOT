<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-mask.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:11 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
  ...
  <link
    rel="stylesheet"
    href="../../dist/libs/dropzone/dist/min/dropzone.min.css"
  />
  {/* --------------------------------------------------- */}
  {/* Core Css */}
  {/* --------------------------------------------------- */}
        ...
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Mask</h4>
          ...
          <div className="col-sm-12 col-lg-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Input masks</h4>
              </div>
              <div className="card-body">
                <div className="mb-3">
                  <label className="font-weight-medium fs-3 mb-1">
                    Date Mask
                ...
                <div className="mb-3">
                  <label className="font-weight-medium fs-3 mb-1">
                    Credit Card Number
                    <small className="text-muted">9999 9999 9999 9999</small>
                  </label>
                  <input
                    type="text"
                ...
                <div className="mb-3">
                  <label className="font-weight-medium fs-3 mb-1">
                    SSN <small className="text-muted">999-99-9999</small>
                  </label>
                  <input
                    type="text"
                ...
                <div className="mb-3">
                  <label className="font-weight-medium fs-3 mb-1">
                    ISBN
                    <small className="text-muted">999-99-999-9999-9</small>
                  </label>
                  <input
                    type="text"
                    className="form-control isbn-inputmask"
                    id="isbn-mask"
                ...
                <div className="mb-3">
                  <label className="font-weight-medium fs-3 mb-1">
                    Percentage <small className="text-muted">99%</small>
                  </label>
                  <input
                    type="text"
                    className="form-control percentage-inputmask"
                    id="percentage-mask"
                ...
                <div className="mb-3">
                  <label className="font-weight-medium fs-3 mb-1">
                    Currency<small className="text-muted">$9999</small>
                  </label>
                  <input
                    type="text"
                    className="form-control currency-inputmask"
                    id="currency-mask"
                ...
                <div className="mb-3">
                  <label className="font-weight-medium fs-3 mb-1">
                    Decimal using RadixPoint
                    <small className="text-muted">123.654658</small>
                  </label>
                  <input
                    type="text"
                    className="form-control decimal-inputmask"
                    id="decimal-mask"
                ...
                <div className="mb-3">
                  <label className="font-weight-medium fs-3 mb-1">
                    Email<small className="text-muted">xxx@xxx.xxx</small>
                  </label>
                  <input
                    type="text"
                ...
                <div className="mb-3">
                  <label>
                    Optional masks
                    <small className="text-muted">(99) 9999[9]-9999</small>
                  </label>
                  <input
                    type="text"
                    className="form-control optional-inputmask"
                    id="optional-mask"
                ...
                <div className="mb-3">
                  <label className="font-weight-medium fs-3 mb-1">
                    3 Number and 3 Lettter
                    <small className="text-muted">123-ABC</small>
                  </label>
                  <input
                ...
                <div className="mb-3">
                  <label className="font-weight-medium fs-3 mb-1">
                    Date and Time in Once
                    <small className="text-muted">yyyy-mm-dd'T'HH:MM:ss</small>
                  </label>
                  <input
                    className="form-control"
                    id="date-time-once"
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-mask.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:12 GMT */}
</>
