<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-input-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:41:57 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
        ...
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Form Input Grid</h4>
            ...
            <div className="col-12">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="mb-3">
                    <h5 className="mb-0">Horizontal Grid</h5>
                  </div>
                  <form action="#">
                    ...
                    <div className="form-actions">
                      <div className="text-end">
                        <button
                          type="submit"
                          className="btn btn-light-primary text-primary font-medium"
                        >
                          Submit
                        </button>
                        <button
                          type="reset"
                          className="btn btn-light-danger text-danger font-medium"
                        >
                          Reset
                        </button>
                      </div>
          ...
          <div className="row">
            <div className="col-12">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="mb-3">
                    <h5 className="mb-0">Grid With Row Label</h5>
                  </div>
                  <form action="#">
                    <div className="form-body">
          ...
          <div className="row">
            <div className="col-12">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="mb-3">
                    <h5 className="mb-0">Grid With Label</h5>
                  </div>
                  <form action="#">
                    <div className="form-body">
                      <div className="row">
          ...
          <div className="row">
            <div className="col-lg-6">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="mb-3">
                    <h5 className="mb-0">Right Offset</h5>
                  </div>
                  <form action="#">
                    <div className="form-body">
                      <div className="row">
            ...
            <div className="col-lg-6">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="mb-3">
                    <h5 className="mb-0">Left Offset</h5>
                  </div>
                  <form action="#">
                    <div className="form-body">
                      <div className="row">
          ...
          <div className="row">
            <div className="col-lg-6">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="mb-3">
                    <h5 className="mb-0">Centered Input</h5>
                  </div>
                  <form action="#">
                    <div className="form-body">
                      <div className="row">
                      ...
                      <div className="row">
                        <label className="col-md-4 text-end">Label</label>
                        <div className="col-md-4">
                          <div className="mb-3">
                            <input
                              type="text"
                      ...
                      <div className="row">
                        <label className="col-md-3 text-end">Label</label>
                        <div className="col-md-6">
                          <div className="mb-3">
                            <input
                              type="text"
                      ...
                      <div className="row">
                        <label className="col-md-2 text-end">Label</label>
                        <div className="col-md-8">
                          <div className="mb-3">
                            <input
                              type="text"
                      ...
                      <div className="row">
                        <label className="col-md-1 text-end">Label</label>
                        <div className="col-md-10">
                          <div className="mb-3">
                            <input
                              type="text"
            ...
            <div className="col-lg-6">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="mb-3">
                    <h5 className="mb-0">Centered Input with Default label</h5>
                  </div>
                  <form action="#">
                    <div className="form-body">
                      <div className="row">
                ...
                <div className="card-body">
                  ...
                  <form action="#">
                    <div className="form-body">
                      <div className="mb-3">
                        <div className="row">
                          <label className="col-lg-1">Label</label>
          ...
          <div className="row">
            <div className="col-12">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="mb-3">
                    <h5 className="mb-0">Grid With Inline Input Label</h5>
                  </div>
                  <form action="#">
                    <div className="form-body">
                      <div className="mb-3">
                        <div className="row">
                          ...
                          <div className="col-md-10">
                            <div className="row">
                              <label className="col-md-4 text-end">
                                Label{" "}
                              </label>
                              <div className="col-md-8">
                                <input
          ...
          <div className="row">
            <div className="col-12">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="mb-3">
                    <h5 className="mb-0">Multiple Input With Default Label</h5>
                  </div>
                  <form action="#">
                    <div className="form-body">
                      <label>Label </label>
          ...
          <div className="row">
            <div className="col-12">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="mb-3">
                    <h5 className="mb-0">Multiple Input With Inline Label</h5>
                  </div>
                  <form action="#">
                    <div className="form-body">
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-input-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:41:58 GMT */}
</>
