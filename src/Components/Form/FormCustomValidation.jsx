<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-custom-validation.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:15 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
  ...
  <link
    rel="stylesheet"
    href="../../dist/libs/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css"
  />
  {/* --------------------------------------------------- */}
  {/* Core Css */}
  {/* --------------------------------------------------- */}
        ...
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Custom-Validation</h4>
          ...
          <div className="col-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Validation Form</h4>
              </div>
              <div className="card-body">
                <form className="mt-4" noValidate="">
                  ...
                  <div className="mb-3 form-group">
                    <label>
                      Email Field <span className="text-danger">*</span>
                    </label>
                    <div className="controls">
                      <input
                        type="email"
                  ...
                  <div className="mb-3 form-group">
                    <label>
                      Input with Icon <span className="text-danger">*</span>
                    </label>
                    <div className="controls">
                  ...
                  <div className="mb-3 form-group">
                    <label>
                      Only Numbers <span className="text-danger">*</span>
                    </label>
                    <div className="input-group">
                      <span className="input-group-text">
                  ...
                  <div className="mb-3 form-group">
                    <label>
                      Maximum Number <span className="text-danger">*</span>
                    </label>
                    <input
                      type="text"
                      name="maxNum"
                  ...
                  <div className="mb-3 form-group">
                    <label>
                      Minimum Number <span className="text-danger">*</span>
                    </label>
                    <div className="controls">
                      <input
                        type="text"
                  ...
                  <div className="mb-3 form-group">
                    <label>
                      Basic Select <span className="text-danger">*</span>
                    </label>
                    <div className="controls">
                      <select
                        name="select"
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-custom-validation.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:17 GMT */}
</>
