<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-bootstrap-touchspin.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:41:58 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
  ...
  <link
    rel="stylesheet"
    href="../../dist/libs/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.css"
  />
  {/* --------------------------------------------------- */}
  {/* Core Css */}
  {/* --------------------------------------------------- */}
  ...
  >
    ...
    <div className="body-wrapper">
      ...
      <div className="container-fluid">
        ...
        <section className="bootstrap-touchspin">
          <p>
            We have used thirdparty plugin js of bootstrap touchspin and you can
            find the official website here:
            <a href="https://www.virtuosoft.eu/code/bootstrap-touchspin/">
              Bootstrap Touchspin
            </a>
          </p>
          <div className="row">
            <div className="col-lg-4 col-md-6">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="mb-4">
                    <h5 className="mb-0">Normal Touchspin</h5>
                  </div>
                  <form className="mt-3">
                    <input
                      id="demo3"
            ...
            <div className="col-lg-4 col-md-6">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="mb-4">
                    <h5 className="mb-0">Postfix Touchspin</h5>
                  </div>
                  <form className="mt-3">
                    <input
                      id="demo1"
            ...
            <div className="col-lg-4 col-md-6">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="mb-4">
                    <h5 className="mb-0">Prefix Touchspin</h5>
                  </div>
                  <form className="mt-3">
            ...
            <div className="col-lg-6">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="mb-4">
                    <h5 className="mb-0">Vertical button alignment</h5>
                  </div>
                  <form className="mt-3">
                    <div className="form-group">
                      <input
            ...
            <div className="col-lg-6">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="mb-4">
                    <h5 className="mb-0">Vertical buttons with custom icons</h5>
                  </div>
                  <form className="mt-3">
                    <div className="form-group">
                      <input
            ...
            <div className="col-lg-6">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="mb-4">
                    <h5 className="mb-0">Touchspin With Button (small)</h5>
                  </div>
                  <form className="mt-3">
                    <div className="form-group">
            ...
            <div className="col-lg-6">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="mb-4">
                    <h5 className="mb-0">Prefix Touchspin (large)</h5>
                  </div>
            ...
            <div className="col-lg-6">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="mb-4">
                    <h5 className="mb-0">Change Button Class</h5>
                  </div>
                  <form className="form-horizontal mt-3">
                    <div className="form-group">
                      <input
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-bootstrap-touchspin.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:41:59 GMT */}
</>
