<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-actions.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:42 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
        ...
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Form Actions</h4>
                ...
                <form>
                  <div className="card-body">
                    ...
                    <p className="card-subtitle mb-3">
                      ...
                      <mark>
                        <code>.action-form</code>
                      </mark>{" "}
                      class to begining the form.
                    </p>
                    <div
                      className="alert bg-light-primary text-primary alert-dismissible fade show"
                      role="alert"
                    >
                      <div className="d-flex align-items-center text-primary font-medium">
                    ...
                    <div className="action-form">
                      <div className="mb-3 mb-0 text-start">
                        <button
                          type="submit"
                        ...
                        <button
                          type="submit"
                          className="btn btn-dark rounded-pill px-4 waves-effect waves-light"
                        >
                          Cancel
                        </button>
                      </div>
            ...
            <div className="col-lg-6 d-flex align-items-stretch">
              ...
              <div className="card w-100">
                <div className="card-body pb-0">
                  ...
                  <div
                    className="alert bg-light-primary text-info alert-dismissible fade show"
                    role="alert"
                  >
                    <div className="d-flex align-items-center text-primary font-medium">
                      <i className="ti ti-info-circle me-2 fs-4" />
                ...
                <div className="card-body border-top">
                  <h5 className="mb-3">About Employee</h5>
                  <div className="row">
                    <div className="col-sm-12 col-md-6">
                      <div className="mb-3">
                        <label
              ...
              <div className="card w-100">
                <form>
                  <div className="card-body">
                    ...
                    <p className="card-subtitle mb-3 mt-3">
                      To use add form actions on top of the form add a div with
                      <mark>
                        <code>.action-form</code>
                      </mark>{" "}
                      class to the ending of the form. To set a side of the
                      button use
                      <mark>
            ...
            <div className="col-lg-6 d-flex align-items-stretch">
              ...
              <div className="card w-100">
                <form>
                  <div className="card-body">
                    <div className="d-flex no-block align-items-center">
                      <h5 className="mb-0">Complaint Form</h5>
                      <div className="ms-auto">
                        <div className="btn-group">
                          <button
                            type="button"
                            className="btn btn-light-secondary text-secondary font-medium dropdown-toggle"
                            data-bs-toggle="dropdown"
                            aria-haspopup="true"
                            aria-expanded="false"
                          >
                    ...
                    <p className="card-subtitle mt-3 mb-3">
                      To use add form actions on top of the form add a div with
                      <mark>
                        <code>.action-form</code>
                      </mark>{" "}
                ...
                <form>
                  <div className="card-body">
                    ...
                    <p className="card-subtitle mb-3">
                      ...
                      class to begining and ending of the form. To set a side of
                      the button use
                      <mark>
                        ...
                        <div className="mb-3">
                          ...
                          <div className="input-group">
                            <span
                              ...
                              id="basic-addon1"
                            >
                              <i className="ti ti-briefcase fs-4" />
                            </span>
                            <input
                              type="text"
                              className="form-control"
                        ...
                        <div className="mb-3">
                          ...
                          <div className="input-group">
                            <span
                              ...
                              id="basic-addon1"
                            >
                              <i className="ti ti-clock-hour-4 fs-4" />
                            </span>
                            <input
                              type="time"
                              className="form-control"
                ...
                <form>
                  <div className="card-body">
                    ...
                    <p className="card-subtitle mb-3">
                      ...
                      at which side you want to add buttons.
                    </p>
                    <div
                      className="alert bg-light-primary text-info alert-dismissible fade show"
                      role="alert"
                      ...
                      <div className="ms-auto">
                        ...
                        <div className="btn-group">
                          <button
                            ...
                            aria-expanded="false"
                          >
                            <i className="ti ti-transition-right me-1 fs-4" />
                            Export
                          </button>
                          <div className="dropdown-menu">
                            <a
                        ...
                        <div className="btn-group">
                          <button
                            ...
                            aria-expanded="false"
                          >
                            <i className="ti ti-upload me-1 fs-4" />
                            Upload
                          </button>
                          <div className="dropdown-menu">
                            <a
