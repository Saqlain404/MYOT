<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:52 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
        ...
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Form Detail</h4>
            ...
            <div className="col-lg-12">
              ...
              <div className="card">
                <div className="card-header bg-primary">
                  <h5 className="mb-0 text-white">Form with view only</h5>
                </div>
                <form className="form-horizontal">
                  <div className="form-body">
                    <div className="card-body">
                      <h5 className="card-title mb-0">Person Info</h5>
                    </div>
                      ...
                      <div className="row">
                        <div className="col-md-6">
                          <div className="form-group row">
                            <label className="control-label text-end col-md-3">
                              First Name:
                            </label>
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-6">
                          <div className="form-group row">
                            ...
                            <div className="col-md-9">
                              <p className="form-control-static">11/06/1987</p>
                            </div>
                          </div>
                        </div>
                        {/*/span*/}
                      ...
                      <div className="row">
                        <div className="col-md-6">
                          <div className="form-group row">
                            ...
                            <div className="col-md-9">
                              <p className="form-control-static">Category1</p>
                            </div>
                          </div>
                        </div>
                        {/*/span*/}
                        <div className="col-md-6">
                          <div className="form-group row">
                            ...
                            <div className="col-md-9">
                              <p className="form-control-static">Free</p>
                            </div>
                          </div>
                        </div>
                        {/*/span*/}
                      ...
                      <div className="row">
                        <div className="col-md-6">
                          <div className="form-group row">
                            ...
                            <div className="col-md-9">
                              <p className="form-control-static">Bhavnagar</p>
                            </div>
                          </div>
                        </div>
                        {/*/span*/}
                        <div className="col-md-6">
                          <div className="form-group row">
                            ...
                            <div className="col-md-9">
                              <p className="form-control-static">Gujarat</p>
                            </div>
                          </div>
                        </div>
                        {/*/span*/}
