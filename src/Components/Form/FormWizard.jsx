<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-wizard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:53 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
        ...
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Form Wizard</h4>
        ...
        <section>
          <div className="row">
            ...
            <div className="col-12">
              ...
              <div className="card">
                <div className="card-body">
                  <h4 className="card-title mb-0">Basic Example</h4>
                  <h6 className="card-subtitle mb-3" />
                  <div id="example-basic" className="mt-5">
                    <h3>Keyboard</h3>
                    <section>
                      <p>
                        {" "}
            ...
            <div className="col-12">
              ...
              <div className="card">
                <div className="card-body wizard-content">
                  <h4 className="card-title mb-0">Custom Design Example</h4>
                  <h6 className="card-subtitle mb-3" />
                  <form action="#" className="tab-wizard wizard-circle">
                    ...
                    <section>
                      ...
                      <div className="row">
                        <div className="col-md-6">
                          <div className="mb-3">
                            <label htmlFor="location1">Select City :</label>
                            <select
                    ...
                    <section>
                      <div className="row">
                        ...
                        <div className="col-md-6">
                          <div className="mb-3">
                            <label htmlFor="videoUrl1">Company Name :</label>
                            <input
                              type="text"
                              className="form-control"
                              id="videoUrl1"
                    ...
                    <section>
                      <div className="row">
                        <div className="col-md-6">
                          <div className="mb-3">
                            <label htmlFor="int1">Interview For :</label>
                            <input
                              type="text"
                              className="form-control"
                              id="int1"
                          ...
                          <div className="mb-3">
                            <label htmlFor="intType1">Interview Type :</label>
                            <select
                              className="form-select"
                              id="intType1"
                        ...
                        <div className="col-md-6">
                          <div className="mb-3">
                            <label htmlFor="jobTitle2">Interview Date :</label>
                            <input
                              type="date"
                              className="form-control"
                              id="jobTitle2"
            ...
            <div className="col-12">
              ...
              <div className="card">
                <div className="card-body wizard-content">
                  ...
                  <form
                    action="#"
                    className="validation-wizard wizard-circle mt-5"
                  >
                    {/* Step 1 */}
                    <h6>Step 1</h6>
                    <section>
            ...
            <div className="col-12">
              ...
              <div className="card">
                <div className="card-body wizard-content">
                  <h4 className="card-title mb-0">Step wizard Vertical</h4>
                  <h6 className="card-subtitle mb-3" />
                  <form
                    action="#"
                    className="tab-wizard vertical wizard-circle mt-5"
                  >
                    {/* Step 1 */}
                    <h6>Personal Info</h6>
                    <section>
            ...
            <div className="col-12">
              ...
              <div className="card">
                <div className="card-body">
                  <h4 className="card-title mb-0">Basic Form Example</h4>
                  <h6 className="card-subtitle mb-3" />
            ...
            <div className="col-12">
              ...
              <div className="card">
                <div className="card-body">
                  <h4 className="card-title mb-0">Advanced Form Example</h4>
                  <h6 className="card-subtitle mb-3" />
                  <form id="example-advanced-form" action="#" className="mt-5">
                    <h3>Account</h3>
                    <fieldset>
                      <h4>Account Information</h4>
                      <label htmlFor="userName-2">User name *</label>
                      <input
                        id="userName-2"
                        name="userName"
                        type="text"
                      ...
                      <input
                        ...
                        className="required form-control"
                      />
                      <label htmlFor="confirm-2">Confirm Password *</label>
                      <input
                        id="confirm-2"
                        name="confirm"
                        type="text"
                    ...
                    <fieldset>
                      ...
                      <label htmlFor="name-2">First name *</label>
                      <input
                        id="name-2"
                        name="name"
                        type="text"
                        className="required form-control"
                      />
                      <label htmlFor="surname-2">Last name *</label>
                      <input
                        id="surname-2"
                        name="surname"
                        type="text"
                      ...
                      />
                      <label htmlFor="age-2">
                        Age (The warning step will show up if age is less than
                        18) *
                      </label>
                      <input
                        id="age-2"
                        name="age"
                        type="text"
                        className="required number form-control"
                      />
                      <p>(*) Mandatory</p>
                    </fieldset>
                    <h3>Warning</h3>
            ...
            <div className="col-12">
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <h6 className="card-subtitle mb-3" />
                  <div id="example-manipulation" className="mt-5">
                    <h3>Add Step</h3>
                    <section>
                      <p>
                        <label htmlFor="title-3">HTML Title *</label>
                        <br />
                        <input
                          id="title-3"
                          type="text"
                        ...
                        />
                        <br />
                        <label htmlFor="text-3">HTML Content *</label>
                        <br />
                        <textarea
                          id="text-3"
                          rows={5}
                      ...
                      <p>
                        <a
                          href="javascript:void(0);"
                          onclick="$('#wizard-4').steps('add', { title: $('#title-3').val(), content: $('#text-3').val() });"
                        >
                          Add
                        </a>
                      </p>
                    ...
                    <section>
                      <p>
                        ...
                        />
                        <br />
                        <label htmlFor="title2-3">HTML Title *</label>
                        <br />
                        <input
                          id="title2-3"
                          type="text"
                        ...
                        />
                        <br />
                        <label htmlFor="text2-3">HTML Content *</label>
                        <br />
                        <textarea
                          id="text2-3"
                          rows={5}
                      ...
                      <p>
                        <a
                          href="javascript:void(0);"
                          onclick="$('#wizard-4').steps('insert', Number($('#position-3').val()), { title: $('#title2-3').val(), content: $('#text2-3').val() });"
                        >
                          Insert
                        </a>
                      </p>
                    ...
                    <section>
                      ...
                      <p>
                        <a
                          href="javascript:void(0);"
                          onclick="$('#wizard-4').steps('remove', Number($('#position2-3').val()));"
                        >
                          Remove
                        </a>
                      </p>
            ...
            <div className="col-12">
              ...
              <div className="card">
                <div className="card-body">
                  <h4 className="card-title mb-0">Vertical Steps Example</h4>
                  <h6 className="card-subtitle mb-3" />
                  <div id="example-vertical" className="mt-5">
                    <h3>Keyboard</h3>
                    <section>
                      <p>
                        {" "}
