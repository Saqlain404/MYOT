<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-typeahead.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:12 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
      ...
      <div className="container-fluid">
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Typeahead</h4>
        ...
        <div className="row">
          <div className="col-sm-12 col-lg-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">The Basics</h4>
              </div>
              <div className="card-body">
                <h6 className="card-subtitle mb-3">
                  When initializing a <code>typeahead</code>, you pass the
                  plugin method one or more datasets. The source of a dataset is
          ...
          <div className="col-sm-12 col-lg-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Bloodhound</h4>
              </div>
              <div className="card-body">
                <h6 className="card-subtitle mb-3">
          ...
          <div className="col-sm-12 col-lg-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Prefetch</h4>
              </div>
              <div className="card-body">
                <h6 className="card-subtitle mb-3">
                  Prefetched data is fetched and processed on initialization. If
                  the browser supports local storage, the processed data will be
                  cached there to prevent additional network requests on
          ...
          <div className="col-sm-12 col-lg-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Default Suggestion</h4>
              </div>
              <div className="card-body">
                <h6 className="card-subtitle mb-3">
                  Default suggestions can be shown for empty queries by setting
                  the <code>minLength</code> option to 0 and having the source
          ...
          <div className="col-sm-12 col-lg-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Multiple Datasets</h4>
              </div>
              <div className="card-body">
                <h6 className="card-subtitle mb-3">
          ...
          <div className="col-sm-12 col-lg-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Scrollable Dropdown Menu</h4>
              </div>
              <div className="card-body">
                <h6 className="card-subtitle mb-3">
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-typeahead.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:14 GMT */}
</>
