<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-picker-colorpicker.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:17 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
  ...
  <link
    rel="stylesheet"
    href="../../dist/libs/%40claviska/jquery-minicolors/jquery.minicolors.css"
  />
  {/* --------------------------------------------------- */}
  {/* Core Css */}
  {/* --------------------------------------------------- */}
      ...
      <div className="container-fluid">
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Picker-Colorpicker</h4>
        ...
        <div className="row">
          <div className="col-12">
            <h4 className="card-title mb-3">Minicolors</h4>
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Control Types</h4>
              </div>
              <div className="card-body">
                <div className="mb-3">
                  <label className="font-weight-medium mb-1" htmlFor="hue-demo">
                    Hue (default)
                  </label>
                  <input
                    type="text"
          ...
          <div className="col-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Input Modes</h4>
              </div>
              <div className="card-body">
                <div className="mb-3">
                  <label
                ...
                <div className="mb-3">
                  <label className="font-weight-medium mb-1" htmlFor="inline">
                    Inline
                  </label>
                  <br />
                  <input
          ...
          <div className="col-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">RGB(A)</h4>
              </div>
              <div className="card-body">
                <div className="row">
                  <div className="col-sm-12 col-md-6">
                    <div className="mb-3">
                      <label className="font-weight-medium mb-1" htmlFor="rgb">
                        RGB
                      </label>
                      <h6 className="help-block text-muted fw-light">
                      ...
                      <input
                        ...
                        className="form-control demo"
                        data-format="rgb"
                        defaultValue="rgb(33, 147, 58)"
                      />
                    </div>
                  </div>
                  <div className="col-sm-12 col-md-6">
                    <div className="mb-3">
                      <label className="font-weight-medium mb-1" htmlFor="rgba">
                        RGBA
                      </label>
                      <h6 className="help-block text-muted fw-light">
          ...
          <div className="col-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Different Styles</h4>
              </div>
              <div className="card-body">
                <div className="row">
                  <div className="col-sm-12 col-md-6">
                  ...
                  <div className="col-sm-12 col-md-6">
                    <div className="mb-3">
                      ...
                      <input
                        ...
                        defaultValue="rgba(14, 206, 235, .5)"
                      />
                    </div>
                  </div>
                </div>
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-picker-colorpicker.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:23 GMT */}
</>
