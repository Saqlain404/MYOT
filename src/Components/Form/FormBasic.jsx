<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:41 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
        ...
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Form Basic</h4>
            ...
            <div className="col-12">
              ...
              <div className="card">
                <div className="card-body">
                  <h5 className="mb-3">Basic Form</h5>
                  <form>
                    <div className="row">
              ...
              <div className="card">
                <div className="card-body">
                  <h5 className="mb-3">Disabled Form</h5>
                  <form>
                    <fieldset disabled="">
                      <div className="mb-3">
                        <label htmlFor="disabledTextInput1">
                          Disabled input
                        </label>
                        <input
                          type="text"
                      ...
                      <button
                        type="submit"
                        className="btn btn-info rounded-pill px-4 mt-3"
                      >
                        Submit
                      </button>
                    </fieldset>
              ...
              <div className="card card-body">
                <h5 className="mb-3">Custom File Uploads</h5>
                <div className="mb-3">
                ...
                <div className="card-body">
                  ...
                  <form className="">
                    <div className="form-floating mb-3">
                      ...
                      />
                      <label>
                        <i className="ti ti-user me-2 fs-4" />
                        Username
                      </label>
                    </div>
                    <div className="form-floating mb-3">
                      ...
                      />
                      <label>
                        <i className="ti ti-mail me-2 fs-4" />
                        Email address
                      </label>
                    </div>
                    <div className="form-floating mb-3">
                      ...
                      />
                      <label>
                        <i className="ti ti-lock me-2 fs-4" />
                        Password
                      </label>
                    </div>
                    <div className="form-floating mb-3">
                    ...
                    <div className="d-md-flex align-items-center">
                      <div className="form-check mr-sm-2">
                        <input
                          ...
                          defaultValue="check"
                        />
                        <label className="form-check-label" htmlFor="sf1">
                          Remember Me
                        </label>
                      </div>
                ...
                <div className="card-body">
                  ...
                  <form className="">
                    <div className="form-floating mb-3">
                      ...
                      />
                      <label>
                        <i className="ti ti-user me-2 fs-4 text-info" />
                    ...
                    <div className="form-floating mb-3">
                      ...
                      />
                      <label>
                        <i className="ti ti-mail me-2 fs-4 text-info" />
                        <span className="border-start border-info ps-3">
                          Email address
                        </span>
                      </label>
                    ...
                    <div className="form-floating mb-3">
                      ...
                      />
                      <label>
                        <i className="ti ti-lock me-2 fs-4 text-info" />
                        <span className="border-start border-info ps-3">
                          Password
                        </span>
                      </label>
                    ...
                    <div className="d-md-flex align-items-center">
                      <div className="form-check mr-sm-2">
                        <input
                          ...
                          defaultValue="check"
                        />
                        <label className="form-check-label" htmlFor="sf2">
                          Remember Me
                        </label>
                      </div>
                      <div className="mt-3 mt-md-0 ms-auto">
                ...
                <div className="card-body">
                  ...
                  <form className="">
                    <div className="form-floating mb-3">
                      ...
                      />
                      <label>
                        <i className="ti ti-user me-2 fs-4 text-warning" />
                        <span className="border-start border-warning ps-3">
                          Username
                        </span>
                      </label>
                    </div>
                    <div className="form-floating mb-3">
                      ...
                      />
                      <label>
                        <i className="ti ti-mail me-2 fs-4 text-warning" />
                        <span className="border-start border-warning ps-3">
                          Email address
                        </span>
                      </label>
                    ...
                    <div className="form-floating mb-3">
                      ...
                      />
                      <label>
                        <i className="ti ti-lock me-2 fs-4 text-warning" />
                        <span className="border-start border-warning ps-3">
                          Password
                        </span>
                      </label>
                    ...
                    <div className="d-md-flex align-items-center">
                      <div className="form-check mr-sm-2">
                        <input
                          ...
                          defaultValue="check"
                        />
                        <label className="form-check-label" htmlFor="sf3">
                          Remember Me
                        </label>
                      </div>
                      <div className="mt-3 mt-md-0 ms-auto">
                        <button
                          type="submit"
                          className="btn btn-warning font-medium rounded-pill px-4"
                        >
                          <div className="d-flex align-items-center">
                            <i className="ti ti-send me-2 fs-4" />
                            Submit
                ...
                <div className="card-body">
                  ...
                  <form className="">
                    ...
                    <div className="form-floating mb-3">
                      ...
                      />
                      <label>
                        <i className="ti ti-mail me-2 fs-4 text-primary" />
                        <span className="border-start border-primary ps-3">
                          Email address
                        </span>
                      </label>
                    ...
                    <div className="form-floating mb-3">
                      ...
                      />
                      <label>
                        <i className="ti ti-lock me-2 fs-4 text-primary" />
                        <span className="border-start border-primary ps-3">
                          Password
                        </span>
                      </label>
                    ...
                    <div className="d-md-flex align-items-center">
                      <div className="form-check mr-sm-2">
                        <input
                          ...
                          defaultValue="check"
                        />
                        <label className="form-check-label" htmlFor="sf4">
                          Remember Me
                        </label>
                      </div>
                      <div className="mt-3 mt-md-0 ms-auto">
                ...
                <div className="card-body">
                  ...
                  <form className="">
                    <div className="form-floating mb-3">
                      ...
                      />
                      <label>
                        <i className="ti ti-user me-2 fs-4 text-success" />
                        <span className="border-start border-success ps-3">
                          Username
                        </span>
                      </label>
                    </div>
                    <div className="form-floating mb-3">
                      ...
                      />
                      <label>
                        <i className="ti ti-mail me-2 fs-4 text-success" />
                        <span className="border-start border-success ps-3">
                          Email address
                        </span>
                      </label>
                    ...
                    <div className="form-floating mb-3">
                      ...
                      />
                      <label>
                        <i className="ti ti-lock me-2 fs-4 text-success" />
                        <span className="border-start border-success ps-3">
                          Password
                        </span>
                      </label>
                    ...
                    <div className="d-md-flex align-items-center">
                      <div className="form-check mr-sm-2">
                        <input
                          ...
                          defaultValue="check"
                        />
                        <label className="form-check-label" htmlFor="sf5">
                          Remember Me
                        </label>
                      </div>
                      <div className="mt-3 mt-md-0 ms-auto">
                        <button
                          type="submit"
                          className="btn btn-success font-medium rounded-pill px-4"
                        >
                          <div className="d-flex align-items-center">
                            <i className="ti ti-send me-2 fs-4" />
                            Submit
                ...
                <div className="card-body">
                  ...
                  <form className="">
                    <div className="form-floating mb-3">
                      ...
                      />
                      <label>
                        <i className="ti ti-user me-2 fs-4 text-danger" />
                        <span className="border-start border-danger ps-3">
                          Username
                        </span>
                      </label>
                    </div>
                    <div className="form-floating mb-3">
                      ...
                      />
                      <label>
                        <i className="ti ti-mai me-2 fs-4 text-danger" />
                        <span className="border-start border-danger ps-3">
                          Email address
                        </span>
                      </label>
                    ...
                    <div className="form-floating mb-3">
                      ...
                      />
                      <label>
                        <i className="ti ti-lock me-2 fs-4 text-danger" />
                        <span className="border-start border-danger ps-3">
                          Password
                        </span>
                      </label>
                    ...
                    <div className="d-md-flex align-items-center">
                      <div className="form-check mr-sm-2">
                        <input
                          ...
                          defaultValue="check"
                        />
                        <label className="form-check-label" htmlFor="sf6">
                          Remember Me
                        </label>
                      </div>
                      <div className="mt-3 mt-md-0 ms-auto">
                        <button
                          type="submit"
                          className="btn btn-danger font-medium rounded-pill px-4"
                        >
                          <div className="d-flex align-items-center">
                            <i className="ti ti-send me-2 fs-4" />
                            Submit
              ...
              <div className="card card-body">
                ...
                <form className="form-horizontal">
                  <div className="mb-3">
                    <label>
                      Default Text
                      <span className="help"> e.g. "George deo"</span>
                    </label>
                    <input
                      type="text"
                      className="form-control"
                  ...
                  <div className="mb-3">
                    <label htmlFor="example-email">
                      Email
                      <span className="help">e.g. "example@gmail.com"</span>
                    </label>
                    <input
                      type="email"
                      id="example-email"
            ...
            <div className="col-lg-12">
              ...
              <div className="card">
                <div className="card-header bg-primary">
                  <h4 className="mb-0 text-white">Other Sample form</h4>
                </div>
                <form action="#">
                  <div>
                    <div className="card-body">
                    ...
                    <form className="input-form">
                      ...
                      <div className="row">
                        <div className="col-lg-12">
                          <div className="input-group mb-3">
                            <button
                              className="btn btn-light-danger font-medium text-danger"
                              type="button"
                            >
                              <div className="d-flex align-items-center">
                                <i className="ti ti-circle-half me-1 fs-4" />
                                Hate It
                              </div>
                            </button>
                            <input
                            ...
                            />
                            <button
                              className="btn btn-danger text-white font-medium"
                              type="button"
                            >
                              <div className="d-flex align-items-center">
                                <i className="ti ti-heart me-1 fs-4" />
                                Love It
                              </div>
                            </button>
                          </div>
                    ...
                    <form className="input-form">
                      <div className="row">
                        <div className="col-lg-6">
                          <div className="input-group mb-3">
                            <button
                              className="btn btn-light-secondary text-secondary dropdown-toggle"
                              type="button"
                              data-bs-toggle="dropdown"
                              aria-haspopup="true"
                              aria-expanded="false"
