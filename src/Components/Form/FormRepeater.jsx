<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-repeater.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:59 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
      ...
      <div className="container-fluid">
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Form Repeater</h4>
          ...
          <div className="col-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Full Form Repeater</h4>
              </div>
                ...
                <div className="repeater-default mt-4">
                  ...
                  "
                    >
                      <div className="d-flex align-items-center">
                        Add
                        <i className="ti ti-circle-plus ms-1 fs-5" />
                      </div>
                    </button>
                  </div>
                </div>
        ...
        <div className="row">
          <div className="col-12 col-lg-6">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Form Control Repeater</h4>
              </div>
              <div className="card-body">
                <form className="mt-4">
                  <div className="">
                        ...
                        <div data-repeater-item="" className="row mb-3">
                          ...
                          <div className="col-md-2">
                            <button
                              ...
                              type="button"
                            >
                              <i className="ti ti-circle-x fs-5" />
                            </button>
                          </div>
                        </div>
                      </div>
          ...
          <div className="col-md-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Dynamic Form Fields</h4>
              </div>
              <div className="card-body">
                <div id="education_fields" className="my-4" />
                <form className="row">
                  ...
                  <div className="col-sm-2">
                    ...
                    "
                        type="button"
                      >
                        <i className="ti ti-circle-plus fs-5" />
                      </button>
                    </div>
                  </div>
                </form>
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-repeater.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:43:11 GMT */}
</>
