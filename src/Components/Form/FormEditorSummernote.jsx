<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-editor-summernote.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:37 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
  ...
  <link
    rel="stylesheet"
    href="../../dist/libs/summernote/dist/summernote-lite.min.css"
  />
  {/* --------------------------------------------------- */}
  {/* Core Css */}
  {/* --------------------------------------------------- */}
      ...
      <div className="container-fluid">
        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
          <div className="card-body px-4 py-3">
            <div className="row align-items-center">
              <div className="col-9">
                <h4 className="fw-semibold mb-8">Summernote</h4>
        ...
        <div className="row">
          <div className="col-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Default Summernote Editor</h4>
              </div>
                  ...
                  <div className="click2edit">
                    <h1>
                      <img
                        ...
                        className="right"
                        src="../../dist/images/backgrounds/img1.jpg"
                        height={250}
                      />
                      Apollo 11
                    </h1>
                    <p>
                      <strong>Apollo 11</strong> was the spaceflight that landed
                      the first humans, Americans
                    ...
                    <p>
                      ...
                      and together they collected 47.5 pounds (21.5&nbsp;kg) of
                      lunar material for return to Earth. A third member of the
                      mission,
                    ...
                    <h2>
                      ...
                      <a id="quotes" name="quotes" />
                    </h2>
                    <p>
                      Broadcast on live TV to a world-wide audience, Armstrong
                      stepped onto the lunar surface and described the event as:
                    </p>
                    <blockquote>
                      <p>
                    ...
                    <p>
                      ...
                      <a href="http://en.wikipedia.org/wiki/Space_Race">
                        Space Race
                      </a>
                      and fulfilled a national goal proposed in 1961 by the late
                      U.S. President
                    ...
                    <h2>
                      Technical details
                      <a id="tech-details" name="tech-details" />
                    </h2>
                    <table
                      align="right"
                      border={1}
                    ...
                    <p>
                      ...
                      <a href="http://en.wikipedia.org/wiki/NASA">NASA</a>'s
                    ...
                    <ol>
                      ...
                      <li>
                        ...
                        Command Module with propulsion, electrical power, oxygen
                        and water
                      </li>
                      <li>
                    ...
                    <p>
                      ...
                      stage, the astronauts separated the spacecraft from it and
                      travelled for three days until they entered into lunar
                      orbit. Armstrong and Aldrin then moved into the Lunar
                      Module and landed in the
                      <a href="http://en.wikipedia.org/wiki/Mare_Tranquillitatis">
                        Sea of Tranquility
                      </a>
                      . They stayed a total of about 21 and a half hours on the
                      lunar surface. After lifting off in the upper part of the
                      Lunar Module and rejoining Collins in the Command Module,
                      they returned to Earth and landed in the
                      <a href="http://en.wikipedia.org/wiki/Pacific_Ocean">
                        Pacific Ocean
                      </a>
                      on July 24.
                    </p>
                    ...
                    <p>
                      <small>
                        Source:
                        <a href="http://en.wikipedia.org/wiki/Apollo_11">
                          Wikipedia.org
                        </a>
                      </small>
                    </p>
          ...
          <div className="col-12">
            <div className="card">
              <div className="border-bottom title-part-padding">
                <h4 className="card-title mb-0">Airmode Summernote</h4>
              </div>
              <div className="card-body">
                <div className="airmode-summer">
                  <div className="border p-3 mt-3">
                    <div className="click2edit">
                      <h1>
                        <img
                      ...
                      <h2>
                        Technical details
                        <a id="tech-details2" name="tech-details2" />
                      </h2>
                      <table
                        align="right"
                        border={1}
                      ...
                      <p>
                        ...
                        . They stayed a total of about 21 and a half hours on
  ...
  {/* ---------------------------------------------- */}
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-editor-summernote.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:42:40 GMT */}
</>
