<>
  {/* Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/table-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 06:43:11 GMT */}
  {/* --------------------------------------------------- */}
  {/* Title */}
  {/* --------------------------------------------------- */}
      ...
      <div className="container-fluid">
        ...
        <div className="card w-100 position-relative overflow-hidden">
          <div className="px-4 py-3 border-bottom">
            <h5 className="card-title fw-semibold mb-0 lh-sm">Basic Table</h5>
          </div>
              ...
              <table className="table border text-nowrap customize-table mb-0 align-middle">
                <thead className="text-dark fs-4">
                  <tr>
                    ...
                    <th>
                      <h6 className="fs-4 fw-semibold mb-0">Team</h6>
                    </th>
                    <th>
              ...
              <table className="table border text-nowrap customize-table mb-0 align-middle">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <span className="badge bg-light-primary rounded-3 py-8 text-primary fw-semibold fs-2">
                        active
                      </span>
                    </td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <span className="badge bg-light-danger rounded-3 py-8 text-danger fw-semibold fs-2">
                        cancel
                      </span>
                    </td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <span className="badge bg-light-success rounded-3 py-8 text-success fw-semibold fs-2">
                        pending
                      </span>
                    </td>
                    <td>
              ...
              <table className="table border text-nowrap customize-table mb-0 align-middle">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <span className="badge bg-light-success text-success fw-semibold fs-2 gap-1 d-inline-flex align-items-center">
                    ...
                    <td>
                      <div className="d-flex align-items-center gap-2">
                        <span className="badge bg-primary rounded-3 fw-semibold fs-2">
                          Design
                        </span>
                        <span className="badge bg-secondary rounded-3 fw-semibold fs-2">
                          Product
                        </span>
                      </div>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <span className="badge bg-light text-dark fw-semibold fs-2 gap-1 d-inline-flex align-items-center">
                    ...
                    <td>
                      <div className="d-flex align-items-center gap-2">
                        ...
                        <span className="badge bg-danger rounded-3 fw-semibold fs-2">
                          Operations
                        </span>
                      </div>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex align-items-center gap-2">
                        ...
                        <span className="badge bg-success rounded-3 fw-semibold fs-2">
                          Customer Success
                        </span>
                      </div>
                    </td>
            ...
            <div className="table-responsive rounded-2 mb-4">
              <table className="table border text-nowrap customize-table mb-0 align-middle">
                <thead className="text-dark fs-4">
                  <tr>
                    <th>
                      <h6 className="fs-4 fw-semibold mb-0">Invoice</h6>
                    </th>
                    <th>
                      <h6 className="fs-4 fw-semibold mb-0">Status</h6>
                    </th>
                    ...
                    <th>
                      <h6 className="fs-4 fw-semibold mb-0">Progress</h6>
                    </th>
                    <th />
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td>
                      <h6 className="fw-semibold mb-0">INV-3066</h6>
                    </td>
                    <td>
                      <span className="badge bg-light-primary rounded-3 py-2 text-primary fw-semibold fs-2 d-inline-flex align-items-center gap-1">
                        <i className="ti ti-check fs-4" />
                        paid
                      </span>
                    </td>
                    <td>
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ms-3">
                          <h6 className="fs-4 fw-semibold mb-0">Olivia Rhye</h6>
                          <span className="fw-normal">olivia@ui.com</span>
                        </div>
                      </div>
                    </td>
                    <td>
                      <div className="d-flex align-items-center gap-3">
                        ...
                        <span className="fw-normal">60%</span>
                      </div>
                    </td>
                    <td>
                      <div className="dropdown dropstart">
                  ...
                  <tr>
                    <td>
                      <h6 className="fw-semibold mb-0">INV-3067</h6>
                    </td>
                    <td>
                      <span className="badge bg-light-danger rounded-3 py-2 text-danger fw-semibold fs-2 d-inline-flex align-items-center gap-1">
                        <i className="ti ti-x fs-4" />
                        cancelled
                      </span>
                    </td>
                    <td>
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ms-3">
                          ...
                          <span className="fw-normal">steele@ui.com</span>
                        </div>
                      </div>
                    </td>
                    <td>
                  ...
                  <tr>
                    <td>
                      <h6 className="fw-semibold mb-0">INV-3068</h6>
                    </td>
                    <td>
                      <span className="badge bg-light-primary rounded-3 py-2 text-primary fw-semibold fs-2 d-inline-flex align-items-center gap-1">
                        <i className="ti ti-check fs-4" />
                    ...
                    <td>
                      <div className="d-flex align-items-center gap-3">
                        ...
                        <span className="fw-normal">45%</span>
                      </div>
                    </td>
                    <td>
                      <div className="dropdown dropstart">
                  ...
                  <tr>
                    <td>
                      <h6 className="fw-semibold mb-0">INV-3069</h6>
                    </td>
                    <td>
                      <span className="badge bg-light-secondary rounded-3 py-2 text-secondary fw-semibold fs-2 d-inline-flex align-items-center gap-1">
                        <i className="ti ti-arrow-back-up fs-4" />
                        refunded
                      </span>
                    </td>
                    <td>
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ms-3">
                          <h6 className="fs-4 fw-semibold mb-0">Evelyn Pope</h6>
                          <span className="fw-normal">teele@ui.com</span>
                        </div>
                      </div>
                    </td>
                    <td>
                      <div className="d-flex align-items-center gap-3">
                        ...
                        <span className="fw-normal">37%</span>
                      </div>
                    </td>
                    <td>
                      <div className="dropdown dropstart">
                  ...
                  <tr>
                    <td>
                      <h6 className="fw-semibold mb-0">INV-3070</h6>
                    </td>
                    <td>
                      <span className="badge bg-light-danger rounded-3 py-2 text-danger fw-semibold fs-2 d-inline-flex align-items-center gap-1">
                        <i className="ti ti-x fs-4" />
                    ...
                    <td>
                      <div className="d-flex align-items-center gap-3">
                        ...
                        <span className="fw-normal">87%</span>
                      </div>
                    </td>
                    <td>
                      <div className="dropdown dropstart">
                  ...
                  <tr>
                    <td>
                      <h6 className="fw-semibold mb-0">INV-3071</h6>
                    </td>
                    <td>
                      <span className="badge bg-light-primary rounded-3 py-2 text-primary fw-semibold fs-2 d-inline-flex align-items-center gap-1">
                        <i className="ti ti-check fs-4" />
                    ...
                    <td>
                      <div className="d-flex align-items-center gap-3">
                        ...
                        <span className="fw-normal">32%</span>
                      </div>
                    </td>
                    <td>
                      <div className="dropdown dropstart">
            ...
            <div className="table-responsive rounded-2">
              <table className="table border text-nowrap customize-table mb-0 align-middle">
                <thead className="text-dark fs-4">
                  <tr>
                    <th>
                      <h6 className="fs-4 fw-semibold mb-0">Authors</h6>
                    </th>
                    <th>
                      <h6 className="fs-4 fw-semibold mb-0">Courses</h6>
                    </th>
                    <th>
                      <h6 className="fs-4 fw-semibold mb-0">Users</h6>
                    </th>
                ...
                <tbody>
                  <tr>
                    <td>
                      <div className="d-flex align-items-center">
                        <img
                          src="../../dist/images/blog/blog-img1.jpg"
                          className="rounded-2"
                          width={42}
                          height={42}
                        />
                    ...
                    <td>
                      <div className="d-flex align-items-center gap-2">
                        <span className="badge bg-light-danger text-danger rounded-3 fw-semibold fs-2">
                          Angular
                        </span>
                        <span className="badge bg-light-primary text-primary rounded-3 fw-semibold fs-2">
                          PHP
                        </span>
                      </div>
                    </td>
                    <td>
                      <p className="mb-0 fw-normal">4300 Users</p>
                    </td>
                    <td>
                      <div className="dropdown dropstart">
                        <a
                  ...
                  <tr>
                    <td>
                      <div className="d-flex align-items-center">
                        <img
                          src="../../dist/images/blog/blog-img2.jpg"
                          className="rounded-2"
                          width={42}
                          height={42}
                        />
                        <div className="ms-3">
                          <h6 className="fw-semibold mb-1">Popular Authors</h6>
                    ...
                    <td>
                      <p className="mb-0 fw-normal">1200 Users</p>
                    </td>
                    <td>
                      <div className="dropdown dropstart">
                        <a
                  ...
                  <tr>
                    <td>
                      <div className="d-flex align-items-center">
                        <img
                          src="../../dist/images/blog/blog-img3.jpg"
                          className="rounded-2"
                          width={42}
                          height={42}
                        />
                    ...
                    <td>
                      <div className="d-flex align-items-center gap-2">
                        <span className="badge bg-light-success text-success rounded-3 fw-semibold fs-2">
                          Reactjs
                        </span>
                        <span className="badge bg-light-danger text-danger rounded-3 fw-semibold fs-2">
                          Angular
                    ...
                    <td>
                      <p className="mb-0 fw-normal">2000 Users</p>
                    </td>
                    <td>
                      <div className="dropdown dropstart">
                        <a
                  ...
                  <tr>
                    <td>
                      <div className="d-flex align-items-center">
                        <img
                          src="../../dist/images/blog/blog-img4.jpg"
                          className="rounded-2"
                          width={42}
                          height={42}
                        />
                        <div className="ms-3">
                          <h6 className="fw-semibold mb-1">Active Customers</h6>
                    ...
                    <td>
                      <p className="mb-0 fw-normal">1500 Users</p>
                    </td>
                    <td>
                      <div className="dropdown dropstart">
                        <a
                  ...
                  <tr>
                    <td>
                      <div className="d-flex align-items-center">
                        <img
                          src="../../dist/images/blog/blog-img5.jpg"
                          className="rounded-2"
                          width={42}
                          height={42}
                        />
                        <div className="ms-3">
                          <h6 className="fw-semibold mb-1">Bestseller Theme</h6>
                    ...
                    <td>
                      <p className="mb-0 fw-normal">9500 Users</p>
                    </td>
                    <td>
                      <div className="dropdown dropstart">
                        <a
